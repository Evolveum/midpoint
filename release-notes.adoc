...
* The self-service user interface is now very close to link:https://www.w3.org/TR/WCAG22/[WCAG 2.2] AA compliance.
...
** Configurable xrefv:/midpoint/reference/support-4.10/tasks/activity-policies/[policies] for executing activities. See bug:MID-10412[].
** Better xrefv:/midpoint/reference/support-4.10/tasks/task-errors/[search for errors] in the history of task runs. See bug:MID-10411[].
* Added xrefv:/midpoint/reference/support-4.10/admin-gui/dashboards/compliance-dashboard/[compliance dashboard].
* You can now tighten security guardrails around xrefv:/midpoint/reference/support-4.10/expressions/expressions/[expressions]:
** New xrefv:/midpoint/reference/support-4.10/expressions/expressions/filter/[filter expression evaluator]. See bug:MID-10060[].
** Improved `safe` expression profile in the default system configuration.
** Recommended xrefv:/midpoint/reference/support-4.10/expressions/expressions/security/#semi-safe-configuration[_semi-safe_ configuration of expression profiles] provides a reasonable level of xrefv:/midpoint/reference/support-4.10/expressions/expressions/security/[expression security] for some delegated administration scenarios.
* Improved xrefv:/midpoint/reference/support-4.10/security/audit/#delta-column-changed-items[displaying changes (deltas)] in both the audit GUI and reports.
* Improved xrefv:/midpoint/reference/support-4.10/security/audit/#improving-search-capabilities-for-changed-item-paths-in-audit-records[indexing] these deltas, especially when objects are added. See bug:MID-10413[]
...
* Implemented xrefv:/midpoint/reference/support-4.10/admin-gui/admin-gui-config/#_default_gui_object_list_panel_configuration[default list view panel configuration] which brings a possibility to set the common pagination options for list panels. See bug:MID-10414[].
...
* Implemented xrefv:/midpoint/reference/support-4.10/resources/attribute-caching/#_caching_passwords[shadow password caching], with the possibility of storing them in reversible encrypted form.
* Improved handling of xrefv:/midpoint/reference/support-4.10/resources/resource-configuration/schema-handling/volatility/[volatile shadow attributes].
...
* Added a new configuration attribute for OIDC authentication module that is used for the ID Token signing algorithm. See xrefv:/midpoint/reference/support-4.10/security/authentication/flexible-authentication/modules/oidc/[Oidc Module].
...
* Documented xrefv:/midpoint/reference/support-4.10/resources/shadow/purpose/[shadow purpose]. See bug:MID-10419[].
...
* xrefv:/midpoint/reference/support-4.10/roles-policies/policies/identity-governance-rules/[Compliance-related] marks (no classification, unowned, privileged access), object collections and policies.
* xrefv:/midpoint/reference/support-4.10/roles-policies/policies/privileged-access/[`Privileged access` classification] automatically sets `Privileged access` mark for directly affected roles and users.
...
See bug:MID-9541[] and the xrefv:/midpoint/reference/support-4.10/security/credentials/password-policy/#_ignoreWhenGenerating[docs].
...
This includes xrefv:/midpoint/reference/support-4.10/interfaces/midpoint-client-java/[Java client library],
...
xrefv:/midpoint/reference/support-4.10/repository/native-postgresql/[Native PostgreSQL repository implementation] was developed and tuned specially for PostgreSQL database, taking advantage of native database features, providing improved performance and scalability.
It is currently the only option.

Our strategy is to officially support the latest stable version of PostgreSQL database (to the practically possible extent).
We make no commitments for future support of any other database engines.
See xrefv:/midpoint/reference/support-4.10/repository/repository-database-support/[] page for the details.
...
Please refer to the xrefv:/midpoint/reference/support-4.10/upgrade/upgrade-guide/[] for general instructions and description of the upgrade process.
...
The `synchronize/membership` container was added to the object operation policy object, present in xrefv:/midpoint/reference/support-4.10/concepts/mark/[object marks] (like the `Protected` one).
...
** See xrefv:/midpoint/reference/support-4.10/expressions/expressions/security/[Expression Security] page for a description of recommended use of expression profiles.
