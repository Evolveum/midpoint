...
* The self-service user interface is now very close to link:https://www.w3.org/TR/WCAG22/[WCAG 2.2] AA compliance. See bug:MID-9847[].
...
For more information see xrefv:/midpoint/reference/support-4.10/deployment/ninja/use-case/upgrade-with-ninja/#initial-objects[here].
