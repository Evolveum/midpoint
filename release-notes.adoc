 ...
 * if you are migrating from older PostgreSQL versions to 16, please see xref:/midpoint/guides/updating-native-db/updating-to-pg16/[Guides: Upgrading PostgreSQL Database] for details.
