...
Release {release-version} is a sixtieth midPoint release, code-named _Braille_.
...
* Added page size global configuration for object collection views. See bug:MID-10414[].
...
* Restricted configurable page size by the value of 1000. See bug:MID-10414[].
