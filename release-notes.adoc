...
Release {release-version} is a seventy-sixth midPoint release, code-named _Braille_.
The {release-version} release brings accessibility improvements and miscellaneous bugfixes.
...
* Improved data export by implementing streaming export. See bug:MID-10990[]
...
* Added default sort order to AccessCertificationWorkItem list for stable ordering. See bug:MID-11047[]
* Fixed CSV export filename missing .csv extension. See bug:MID-11046[]
...
* Implemented support for notifyChange REST call without shadow OID. See bug:MID-11230[]
