...
* Added support for Slovenian language (sl).
...
For more information see xrefv:/midpoint/reference/support-4.11/deployment/ninja/use-case/upgrade-with-ninja/#initial-objects[here].
