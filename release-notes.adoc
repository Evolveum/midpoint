...
Release {release-version} is a seventy-three midPoint release, code-named _Curie_.
...
* Updated spring boot to 3.5.14.
* Updated wicket to 10.9.1.
* Updated tomcat to 10.1.55.
* Upgraded webpack, picomatch, plexus, woodstox-core, bouncycastle, nimbus-jose-jwt, fileupload2, netty, xmlsec, postgresql, ldap connector and some other libs.
* Fixed concurrency issue when parsing query. See bug:MID-11058[]
* Fixed dashboard widget showing "Unknown" for ShadowType collections. See bug:MID-11102[]
