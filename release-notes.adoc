...
---
= MidPoint 4.10 "Braille" - Update 3
:release-version: 4.10.3
:page-liquid:
:page-toc: top
...
* Very large traces containing certain UTF-8 strings no longer cause memory overflow on export and are streamed directly to trace files without going through the default Java string to byte array processing. See bug:MID-11015[]
