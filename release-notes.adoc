...
Release {release-version} is a seventy-ninth midPoint release, code-named _Braille_.
The {release-version} release brings accessibility improvements and miscellaneous bug fixes.
