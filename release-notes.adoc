...
* xref:/midpoint/reference/roles-policies/classification/[Information Classification and Clearances]
...
* Implementation of new task activities for certification campaign creation and certification remediation. More details can be found in the xrefv:/midpoint/reference/tasks/activities/work/[Work Definition (Types of Activities)].
