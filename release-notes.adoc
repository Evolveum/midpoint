...
Release {release-version} is a sixty-eighth midPoint release, code-named _Curie_.
...
Made a restructuring of the code.
The goal is to decrease the time period between clearing the authorizations (and other privileges limitations) and filling them in.
See bug:MID-10781[].
