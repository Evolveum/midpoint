...
* Improved xrefv:/midpoint/reference/master/security/audit/#delta-column-changed-items[displaying changes (deltas)] in both the audit GUI and reports.
* Improved xrefv:/midpoint/reference/master/security/audit/#improving-search-capabilities-for-changed-item-paths-in-audit-records[indexing] these deltas, especially when objects are added. See bug:MID-10413[]
