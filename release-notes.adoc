...
* Fixed the issue with overriding the metadata while redundant role request. See bug:MID-10979[].
* Fixed the query for getting the errors on the task details page. See bug:MID-10682[].
* Upgraded libraries (spring-boot, wicket, tomcat, connector-ldap, webpack and others)
