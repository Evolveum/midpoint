...
* xrefv:/midpoint/reference/master/resources/attribute-caching/[Shadow caching]
...
* Improvements regarding xrefv:/midpoint/reference/master/resources/entitlements/[shadow associations]:
...
* Implemented the ability to configure login page form with custom title and description.
Also, custom link can be added to the login page form.
