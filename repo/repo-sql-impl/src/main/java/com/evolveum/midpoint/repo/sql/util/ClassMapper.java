...
public final class ClassMapper {
    ...
    static {
        ...
        types.put(ObjectTypes.ACCESS_CERTIFICATION_TYPE, RObjectType.ACCESS_CERTIFICATION_TYPE);
        types.put(ObjectTypes.ACCESS_CERTIFICATION_RUN, RObjectType.ACCESS_CERTIFICATION_RUN);
