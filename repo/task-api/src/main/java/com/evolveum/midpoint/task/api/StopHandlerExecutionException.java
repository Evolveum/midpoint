 ...
 */
@Experimental
public class StopHandlerExecutionException extends Exception {

    @NotNull private final TaskRunResult runResult;

    public StopHandlerExecutionException(@NotNull TaskRunResult runResult) {
        this.runResult = runResult;
    }

    public StopHandlerExecutionException(RunningTask task, String message, Throwable cause) {
