...
public class GetUserTest extends SqaleRepoBaseTest
    ...
    @Test
    public void test100_Splitted_PureOverhead() throws Exception {
        splitted(0, 0, 0, 0);
    }
    ...
    @Test
    public void test200_Splitted_10a_10r_5l_10o() throws Exception {
        splitted(10, 10, 5, 10);
    }
    ...
    @Test
    public void test300_Splitted_100a_100r_5l_10o() throws Exception {
        splitted(100, 100, 5, 10);
    }
    ...
    @Test
    public void test400_Splitted_1000a_1000r_5l_10o() throws Exception {
        splitted(1000, 1000, 5, 10);
    }



    public void splitted(int assignments, int roleMemberships, int linkRefs, int operationExecutions) throws Exception {
        QUserMapping.getUserMapping().setStoreSplitted(true);
        perform("split", assignments, roleMemberships, linkRefs,  operationExecutions);
    }
    ...
    public void perform(String userPrefix, int assignments, int roleMemberships, int linkRefs, int operationExecutions) throws Exception {
        SqlBaseOperationTracker.setFactory(null);
        ...
        SqlBaseOperationTracker.setFactory(new SimonTrackerFactory(""));
    ...
    private class SimonTrackerFactory extends SqlBaseOperationTracker implements SqlBaseOperationTracker.Factory {
        ...
        public SimonTrackerFactory(String prefix) {
            this.prefix = prefix;
        }
        ...
        protected Tracker createSubresult(String name) {
            var key = name;
            var stopwatch = stopwatches.computeIfAbsent(key, (k) -> stopwatch(k, ""));
            return stopwatch.start()::close;
        }
    }
