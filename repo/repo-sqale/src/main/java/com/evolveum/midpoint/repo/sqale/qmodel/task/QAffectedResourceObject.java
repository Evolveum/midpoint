...
public class QAffectedResourceObject extends QContainer<MAffectedResourceObject, MTask> {
    ...
    public QAffectedResourceObject(String variable) {
        this(variable, DEFAULT_SCHEMA_NAME, TABLE_NAME);
    }

    public QAffectedResourceObject(String variable, String schema, String table) {
        super(MAffectedResourceObject.class, variable, schema, table);
    }
