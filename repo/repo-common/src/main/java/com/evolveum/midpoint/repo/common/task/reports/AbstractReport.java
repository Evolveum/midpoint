...
public abstract class AbstractReport {
    ...
    AbstractReport(@Nullable AbstractExecutionReportConfigurationType definition, @NotNull QName recordTypeName,
        ...
        this.beans = activityState.getActivityExecution().getBeans();
    ...
    private void initializeReportDataObject(OperationResult result) throws CommonException, ActivityExecutionException {
        for (;;) {
    ...
    private void createAndLinkReportDataObject(OperationResult result) throws CommonException, ActivityExecutionException {
    ...
    private String createFileName() {
        ...
        String taskOid = activityState.getActivityExecution().getRunningTask().getOid();
    ...
    private void deleteReference(@NotNull String oid, OperationResult result) throws ActivityExecutionException {
