...
public class TestWorkDistribution extends AbstractTaskManagerTest {
    ...
    public void test100AllocateBucket() throws Exception {
        ...
        // WHEN
	    AbstractWorkBucketType bucket = workStateManager.getWorkBucket(worker.getOid(), 0, result);
    ...
    public void test110AllocateTwoBucketsStandalone() throws Exception {
        ...
        // WHEN
	    AbstractWorkBucketType bucket1 = workStateManager.getWorkBucket(standalone.getOid(), 0, result);
	    AbstractWorkBucketType bucket2 = workStateManager.getWorkBucket(standalone.getOid(), 0, result);
		...
		AbstractWorkBucketType bucket3 = workStateManager.getWorkBucket(standalone.getOid(), 0, result);
		...
		AbstractWorkBucketType bucket4 = workStateManager.getWorkBucket(standalone.getOid(), 0, result);
    ...
    public void test130AllocateReleaseCompleteSequence() throws Exception {
        ...
        // WHEN
	    AbstractWorkBucketType bucket1 = workStateManager.getWorkBucket(worker1.getOid(), 0, result);
	    AbstractWorkBucketType bucket2 = workStateManager.getWorkBucket(worker2.getOid(), 0, result);
	    AbstractWorkBucketType bucket3 = workStateManager.getWorkBucket(worker3.getOid(), 0, result);
	    AbstractWorkBucketType bucket4 = workStateManager.getWorkBucket(worker4.getOid(), 0, result);
	    AbstractWorkBucketType bucket4a = workStateManager.getWorkBucket(worker4.getOid(), 0, result);     // should be the same as bucket4
		...
		AbstractWorkBucketType bucket = workStateManager.getWorkBucket(worker1.getOid(), 0, result);
		...
		// WHEN
		AbstractWorkBucketType nothing = workStateManager.getWorkBucket(worker5.getOid(), 0, result);
		...
		// WHEN
		bucket = workStateManager.getWorkBucket(worker1.getOid(), 100, result);
	...
	protected void assertNoWorkBuckets(TaskWorkStateType ws5) {
		assertTrue(ws5 == null || ws5.getBucket().isEmpty());
	}
...
//        OperationResult result = new OperationResult(TestWorkDistribution.class.getName() + ".addObjectFromFile");
//        try {
//        	add(object, result);
