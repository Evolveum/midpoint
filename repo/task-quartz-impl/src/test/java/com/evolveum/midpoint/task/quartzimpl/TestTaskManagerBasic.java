...
public class TestTaskManagerBasic extends AbstractTaskManagerTest {
    ...
    private static final TestObject<TaskType> TASK_WITHOUT_PROGRESS = TestObject.file(TEST_DIR, "task-without-progress.xml", "91919191-76e0-59e2-86d6-556655660003");
    private static final TestObject<TaskType> TASK_FOR_EXTENSION_TEST = TestObject.file(TEST_DIR, "task-for-extension-test.xml", "91919191-76e0-59e2-86d6-556655660004");
    private static final TestObject<TaskType> TASK_SINGLE_RUN = TestObject.file(TEST_DIR, "task-single-run.xml", "91919191-76e0-59e2-86d6-556655660005");
    private static final TestObject<TaskType> TASK_CYCLE_TIGHT = TestObject.file(TEST_DIR, "task-cycle-tight.xml", "91919191-76e0-59e2-86d6-556655660006");
    private static final TestObject<TaskType> TASK_CYCLE_LOOSE = TestObject.file(TEST_DIR, "task-cycle-loose.xml", "91919191-76e0-59e2-86d6-556655660009");
    private static final TestObject<TaskType> TASK_CYCLE_LOOSE_CRON = TestObject.file(TEST_DIR, "task-cycle-loose-cron.xml", "91919191-76e0-59e2-86d6-556655660010");
    private static final TestObject<TaskType> TASK_TO_SUSPEND = TestObject.file(TEST_DIR, "task-to-suspend.xml", "91919191-76e0-59e2-86d6-556655660012");
    private static final TestObject<TaskType> TASK_TO_RESUME_AND_SUSPEND = TestObject.file(TEST_DIR, "task-to-resume-and-suspend.xml", "91919191-76e0-59e2-86d6-556655660013");
    private static final TestObject<TaskType> TASK_LONG_RUNNING = TestObject.file(TEST_DIR, "task-long-running.xml", "91919191-76e0-59e2-86d6-556655660014");
    private static final TestObject<TaskType> TASK_TO_DELETE = TestObject.file(TEST_DIR, "task-to-delete.xml", "91919191-76e0-59e2-86d6-556655660015");
    private static final TestObject<TaskType> TASK_WAITING_FOR_NO_ONE = TestObject.file(TEST_DIR, "task-waiting-for-no-one.xml", "91919191-76e0-59e2-86d6-556655660017");
    private static final TestObject<TaskType> TASK_SIMPLE_WAITING = TestObject.file(TEST_DIR, "task-simple-waiting.xml", "91919191-76e0-59e2-86d6-556655660020");
    private static final TestObject<TaskType> TASK_TREE_ROOT = TestObject.file(TEST_DIR, "task-tree-root.xml", "91919191-76e0-59e2-86d6-556655660021");
    private static final TestObject<TaskType> TASK_TREE_CHILD_1 = TestObject.file(TEST_DIR, "task-tree-child-1.xml", "91919191-76e0-59e2-86d6-556655661021");
    private static final TestObject<TaskType> TASK_TREE_CHILD_2 = TestObject.file(TEST_DIR, "task-tree-child-2.xml", "91919191-76e0-59e2-86d6-556655662021");
    private static final TestObject<TaskType> TASK_RUN_ON_DEMAND = TestObject.file(TEST_DIR, "task-run-on-demand.xml", "91919191-76e0-59e2-86d6-556655660022");
    private static final TestObject<TaskType> TASK_WITH_THREADS = TestObject.file(TEST_DIR, "task-with-threads.xml", "91919191-76e0-59e2-86d6-556655660100");
    private static final TestObject<TaskType> TASK_WITH_THREADS_TO_SUSPEND = TestObject.file(TEST_DIR, "task-with-threads-to-suspend.xml", "91919191-76e0-59e2-86d6-556655660105");
    private static final TestObject<TaskType> TASK_SEC_GROUP_LIMIT_EXP_1 = TestObject.file(TEST_DIR, "task-sec-group-limit-exp-1.xml", "91919191-76e0-59e2-86d6-556655660108");
    private static final TestObject<TaskType> TASK_SEC_GROUP_LIMIT_EXP_1_RAM_1 = TestObject.file(TEST_DIR, "task-sec-group-limit-exp-1-ram-1.xml", "91919191-76e0-59e2-86d6-55665566a108");
    private static final TestObject<TaskType> TASK_SEC_GROUP_LIMIT_RAM_NULL = TestObject.file(TEST_DIR, "task-sec-group-limit-ram-null.xml", "91919191-76e0-59e2-86d6-55665566b108");
    private static final TestObject<TaskType> TASK_GROUP_LIMIT = TestObject.file(TEST_DIR, "task-group-limit.xml", "91919191-76e0-59e2-86d6-556655660110");
    private static final TestObject<TaskType> TASK_GROUP_LIMIT_CONCURRENT = TestObject.file(TEST_DIR, "task-group-limit-concurrent.xml", "91919191-76e0-59e2-86d6-55665566a110");
    private static final TestObject<TaskType> TASK_ALLOWED = TestObject.file(TEST_DIR, "task-allowed.xml", "91919191-76e0-59e2-86d6-556655660120");
    private static final TestObject<TaskType> TASK_ALLOWED_NOT = TestObject.file(TEST_DIR, "task-allowed-not.xml", "91919191-76e0-59e2-86d6-556655660130");
    private static final TestObject<TaskType> TASK_SUSPENDED_TREE_ROOT = TestObject.file(TEST_DIR, "task-suspended-tree-root.xml", "91919191-76e0-59e2-86d6-556655660200");
    private static final TestObject<TaskType> TASK_SUSPENDED_TREE_CHILD_1 = TestObject.file(TEST_DIR, "task-suspended-tree-child-1.xml", "10000000-76e0-59e2-86d6-556655660200");
    private static final TestObject<TaskType> TASK_SUSPENDED_TREE_CHILD_1_1 = TestObject.file(TEST_DIR, "task-suspended-tree-child-1-1.xml", "11000000-76e0-59e2-86d6-556655660200");
    private static final TestObject<TaskType> TASK_SUSPENDED_TREE_CHILD_2 = TestObject.file(TEST_DIR, "task-suspended-tree-child-2.xml", "20000000-76e0-59e2-86d6-556655660200");
    ...
    private static final TestObject<TaskType> TASK_NON_EXISTING_OWNER = TestObject.file(TEST_DIR, "task-non-existing-owner.xml", "d1320df4-e5b7-43ec-af53-f74ee0b62345");
