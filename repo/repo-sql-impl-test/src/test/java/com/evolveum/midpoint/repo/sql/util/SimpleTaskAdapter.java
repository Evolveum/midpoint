...
public class SimpleTaskAdapter implements Task {
    ...
    @Override public void addModification(ItemDelta<?, ?> delta) {
    }

    @Override public void addModifications(Collection<ItemDelta<?, ?>> deltas) {

    }

    @Override public void addModificationImmediate(ItemDelta<?, ?> delta, OperationResult parentResult) {
    }
    ...
    @Override
    public ObjectReferenceType getReference() {
        return null;
    }
