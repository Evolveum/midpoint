...
BEGIN
    ...
    TRUNCATE TABLE m_audit_resource RESTART IDENTITY CASCADE;
    ...
    TRUNCATE TABLE m_object_policy_situation RESTART IDENTITY CASCADE;
    ...
    TRUNCATE TABLE m_message_template RESTART IDENTITY CASCADE;
