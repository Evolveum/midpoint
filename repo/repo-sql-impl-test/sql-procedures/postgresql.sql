...
BEGIN
  ...
  TRUNCATE TABLE m_any_poly_string RESTART IDENTITY CASCADE;
  ...
  TRUNCATE TABLE m_metadata RESTART IDENTITY CASCADE;
  ...
  TRUNCATE TABLE m_authorization_action RESTART IDENTITY CASCADE;
  TRUNCATE TABLE m_authorization RESTART IDENTITY CASCADE;
