CREATE OR REPLACE FUNCTION cleanupTestDatabase()
  RETURNS INTEGER AS $$
BEGIN
    TRUNCATE TABLE m1_a6_certification_campaign IDENTITY CASCADE;
    TRUNCATE TABLE m1_a6_c13_definition IDENTITY CASCADE;
    ...
    TRUNCATE TABLE m_user_photo RESTART IDENTITY CASCADE;
