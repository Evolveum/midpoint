...
/**
 * Handles changes retrieved by {@link ProvisioningService#synchronize(ResourceShadowDiscriminator, Task, ActivityDefinitionType, LiveSyncEventHandler, OperationResult)} method.
 */
@Experimental
