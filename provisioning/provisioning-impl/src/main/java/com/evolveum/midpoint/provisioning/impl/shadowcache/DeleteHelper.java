...
import static com.evolveum.midpoint.provisioning.impl.shadowcache.ShadowCache.OP_DELAYED_OPERATION;
import static com.evolveum.midpoint.provisioning.impl.shadowcache.Util.*;
...
class DeleteHelper {
    ...
    static final String OP_RESOURCE_OPERATION = ShadowCache.class.getName() + ".resourceOperation";
