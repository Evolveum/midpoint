...
public class AbstractBasicDummyTest extends AbstractDummyTest {
    ...
    public void test024RefinedSchema() throws Exception {
        ...
        assertNotNull("Account object class definition is missing the description parameter value.",accountDef.getNativeObjectClassDefinition().getDescription());
        ...
        fullnameDef.getNativeAttributeName();
        // MID-3144
