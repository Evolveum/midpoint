...
public class TestDummyNegative extends AbstractDummyTest {
    ...
    private static final AnyTestResource RESOURCE_WITH_BROKEN_CONNECTOR_REF = AnyTestResource.file(
            TEST_DIR, "resource-with-broken-connector-ref.xml", "fe1de27d-684c-44c8-9cf6-a691fdf392fd");
    private static final AnyTestResource RESOURCE_TEMPLATE_WITH_BROKEN_CONNECTOR_REF = AnyTestResource.file(
            TEST_DIR, "resource-template-with-broken-connector-ref.xml", "c41900ce-6b86-476a-a7c9-6eb797f7d405");
    private static final AnyTestResource RESOURCE_INSTANCE_WITH_BROKEN_CONNECTOR_REF = AnyTestResource.file(
    ...
    public void initSystem(Task initTask, OperationResult initResult) throws Exception {
        ...
        repoAdd(RESOURCE_WITH_BROKEN_CONNECTOR_REF, initResult);
        repoAdd(RESOURCE_TEMPLATE_WITH_BROKEN_CONNECTOR_REF, initResult);
        repoAdd(RESOURCE_INSTANCE_WITH_BROKEN_CONNECTOR_REF, initResult);
    }
    ...
    public void test103GetResourceTemplateWithBrokenConnectorRef() throws Exception {
        ...
        // There may be a "success" fetch result but let's not assert that here
    }
