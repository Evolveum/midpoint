...
public class ManualConnectorInstance extends AbstractManualConnectorInstance
    ...
    private String addCase(
        ...
        if (ticketingService != null && ticketingResourceOid != null) {
            ...
            TicketingService.TicketingResourceSpec ticketingResourceSpec = new TicketingService.TicketingResourceSpec(
    ...
    private String getShadowIdentifier(Collection<? extends ShadowSimpleAttribute<?>> identifiers) {
        if (identifiers == null || identifiers.isEmpty()) {
            return "";
        }
        try {
            // FIXME treat somehow this magic
            return ((ShadowSimpleAttribute<?>) identifiers.iterator().next()).getValue().getValue().toString();
