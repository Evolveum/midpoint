...
create table m_object_ext_boolean (eName varchar2(157 char) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, booleanValue number(1,0) not null, dynamicDef number(1,0), eType varchar2(157 char), valueType number(10,0), primary key (eName, owner_oid, ownerType, booleanValue)) initrans 30;
create table m_object_ext_date (eName varchar2(157 char) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, dateValue timestamp not null, dynamicDef number(1,0), eType varchar2(157 char), valueType number(10,0), primary key (eName, owner_oid, ownerType, dateValue)) initrans 30;
create table m_object_ext_long (eName varchar2(157 char) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, longValue number(19,0) not null, dynamicDef number(1,0), eType varchar2(157 char), valueType number(10,0), primary key (eName, owner_oid, ownerType, longValue)) initrans 30;
create table m_object_ext_poly (eName varchar2(157 char) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, orig varchar2(255 char) not null, dynamicDef number(1,0), norm varchar2(255 char), eType varchar2(157 char), valueType number(10,0), primary key (eName, owner_oid, ownerType, orig)) initrans 30;
create table m_object_ext_reference (eName varchar2(157 char) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, targetoid varchar2(36 char) not null, dynamicDef number(1,0), relation varchar2(157 char), targetType number(10,0), eType varchar2(157 char), valueType number(10,0), primary key (eName, owner_oid, ownerType, targetoid)) initrans 30;
create table m_object_ext_string (eName varchar2(157 char) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, stringValue varchar2(255 char) not null, dynamicDef number(1,0), eType varchar2(157 char), valueType number(10,0), primary key (eName, owner_oid, ownerType, stringValue)) initrans 30;
