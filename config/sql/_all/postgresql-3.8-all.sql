...
create table m_assignment_ext_boolean (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, booleanValue boolean not null, primary key ( anyContainer_owner_owner_oid, anyContainer_owner_id, item_id, booleanValue));
create table m_assignment_ext_date (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, dateValue timestamp not null, primary key ( anyContainer_owner_owner_oid, anyContainer_owner_id, item_id, dateValue));
create table m_assignment_ext_long (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, longValue int8 not null, primary key ( anyContainer_owner_owner_oid, anyContainer_owner_id, item_id, longValue));
create table m_assignment_ext_poly (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, orig varchar(255) not null, norm varchar(255), primary key ( anyContainer_owner_owner_oid, anyContainer_owner_id, item_id, orig));
create table m_assignment_ext_reference (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, targetoid varchar(36) not null, relation varchar(157), targetType int4, primary key ( anyContainer_owner_owner_oid, anyContainer_owner_id, item_id, targetoid));
create table m_assignment_ext_string (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, stringValue varchar(255) not null, primary key ( anyContainer_owner_owner_oid, anyContainer_owner_id, item_id, stringValue));
...
create table m_ext_item (id  serial not null, kind int4, itemName varchar(157), itemType varchar(157), primary key (id));
...
create table m_object_ext_boolean (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, booleanValue boolean not null, primary key (owner_oid, ownerType, item_id, booleanValue));
create table m_object_ext_date (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, dateValue timestamp not null, primary key (owner_oid, ownerType, item_id, dateValue));
create table m_object_ext_long (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, longValue int8 not null, primary key (owner_oid, ownerType, item_id, longValue));
create table m_object_ext_poly (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, orig varchar(255) not null, norm varchar(255), primary key (owner_oid, ownerType, item_id, orig));
create table m_object_ext_reference (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, targetoid varchar(36) not null, relation varchar(157), targetType int4, primary key (owner_oid, ownerType, item_id, targetoid));
create table m_object_ext_string (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, stringValue varchar(255) not null, primary key (owner_oid, ownerType, item_id, stringValue));
...
create table m_org (displayOrder int4, name_norm varchar(255), name_orig varchar(255), tenant boolean, oid varchar(36) not null, primary key (oid));
...
create table m_service (displayOrder int4, name_norm varchar(255), name_orig varchar(255), oid varchar(36) not null, primary key (oid));
...
alter table if exists m_assignment_ext_boolean add constraint fk_a_ext_boolean_owner foreign key (anyContainer_owner_id, anyContainer_owner_owner_oid) references m_assignment_extension;
alter table if exists m_assignment_ext_boolean add constraint fk_a_ext_boolean_item foreign key (item_id) references m_ext_item;
alter table if exists m_assignment_ext_date add constraint fk_a_ext_date_owner foreign key (anyContainer_owner_id, anyContainer_owner_owner_oid) references m_assignment_extension;
alter table if exists m_assignment_ext_date add constraint fk_a_ext_date_item foreign key (item_id) references m_ext_item;
alter table if exists m_assignment_ext_long add constraint fk_a_ext_long_owner foreign key (anyContainer_owner_id, anyContainer_owner_owner_oid) references m_assignment_extension;
alter table if exists m_assignment_ext_long add constraint fk_a_ext_long_item foreign key (item_id) references m_ext_item;
alter table if exists m_assignment_ext_poly add constraint fk_a_ext_poly_owner foreign key (anyContainer_owner_id, anyContainer_owner_owner_oid) references m_assignment_extension;
alter table if exists m_assignment_ext_poly add constraint fk_a_ext_poly_item foreign key (item_id) references m_ext_item;
alter table if exists m_assignment_ext_reference add constraint fk_a_ext_reference_owner foreign key (anyContainer_owner_id, anyContainer_owner_owner_oid) references m_assignment_extension;
alter table if exists m_assignment_ext_reference add constraint fk_a_ext_boolean_reference foreign key (item_id) references m_ext_item;
alter table if exists m_assignment_ext_string add constraint fk_a_ext_string_owner foreign key (anyContainer_owner_id, anyContainer_owner_owner_oid) references m_assignment_extension;
alter table if exists m_assignment_ext_string add constraint fk_a_ext_string_item foreign key (item_id) references m_ext_item;
...
alter table if exists m_object_ext_boolean add constraint fk_o_ext_boolean_owner foreign key (owner_oid) references m_object;
alter table if exists m_object_ext_boolean add constraint fk_o_ext_boolean_item foreign key (item_id) references m_ext_item;
alter table if exists m_object_ext_date add constraint fk_o_ext_date_owner foreign key (owner_oid) references m_object;
alter table if exists m_object_ext_date add constraint fk_o_ext_date_item foreign key (item_id) references m_ext_item;
alter table if exists m_object_ext_long add constraint fk_object_ext_long foreign key (owner_oid) references m_object;
alter table if exists m_object_ext_long add constraint fk_o_ext_long_item foreign key (item_id) references m_ext_item;
alter table if exists m_object_ext_poly add constraint fk_o_ext_poly_owner foreign key (owner_oid) references m_object;
alter table if exists m_object_ext_poly add constraint fk_o_ext_poly_item foreign key (item_id) references m_ext_item;
alter table if exists m_object_ext_reference add constraint fk_o_ext_reference_owner foreign key (owner_oid) references m_object;
alter table if exists m_object_ext_reference add constraint fk_o_ext_reference_item foreign key (item_id) references m_ext_item;
alter table if exists m_object_ext_string add constraint fk_object_ext_string foreign key (owner_oid) references m_object;
alter table if exists m_object_ext_string add constraint fk_o_ext_string_item foreign key (item_id) references m_ext_item;
alter table if exists m_object_subtype add constraint fk_object_subtype foreign key (object_oid) references m_object;
