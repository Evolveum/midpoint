...
create table m_assignment_ext_boolean (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, booleanValue boolean not null, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, booleanValue));
create table m_assignment_ext_date (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, dateValue timestamp not null, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, dateValue));
create table m_assignment_ext_long (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, longValue int8 not null, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, longValue));
create table m_assignment_ext_poly (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, orig varchar(255) not null, norm varchar(255), primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, orig));
create table m_assignment_ext_reference (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, targetoid varchar(36) not null, relation varchar(157), targetType int4, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, targetoid));
create table m_assignment_ext_string (item_id int4 not null, anyContainer_owner_id int4 not null, anyContainer_owner_owner_oid varchar(36) not null, stringValue varchar(255) not null, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, stringValue));
...
create table m_object_ext_boolean (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, booleanValue boolean not null, primary key (item_id, owner_oid, ownerType, booleanValue));
create table m_object_ext_date (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, dateValue timestamp not null, primary key (item_id, owner_oid, ownerType, dateValue));
create table m_object_ext_long (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, longValue int8 not null, primary key (item_id, owner_oid, ownerType, longValue));
create table m_object_ext_poly (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, orig varchar(255) not null, norm varchar(255), primary key (item_id, owner_oid, ownerType, orig));
create table m_object_ext_reference (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, targetoid varchar(36) not null, relation varchar(157), targetType int4, primary key (item_id, owner_oid, ownerType, targetoid));
create table m_object_ext_string (item_id int4 not null, owner_oid varchar(36) not null, ownerType int4 not null, stringValue varchar(255) not null, primary key (item_id, owner_oid, ownerType, stringValue));
