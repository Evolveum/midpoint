...
create table m_audit_delta (checksum varchar(32) not null, record_id bigint not null, delta longtext, deltaOid varchar(36), deltaType integer, fullResult longtext, objectName_norm varchar(255), objectName_orig varchar(255), resourceName_norm varchar(255), resourceName_orig varchar(255), resourceOid varchar(36), status integer, primary key (checksum, record_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ENGINE=InnoDB;
...
create table m_object_ext_long (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, longValue bigint not null, dynamicDef bit, eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, longValue)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ENGINE=InnoDB;
create table m_object_ext_poly (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, orig varchar(255) not null, dynamicDef bit, norm varchar(255), eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, orig)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ENGINE=InnoDB;
create table m_object_ext_reference (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, targetoid varchar(36) not null, dynamicDef bit, relation varchar(157), targetType integer, eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, targetoid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ENGINE=InnoDB;
create table m_object_ext_string (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, stringValue varchar(255) not null, dynamicDef bit, eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, stringValue)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ENGINE=InnoDB;
...
create table m_exclusion (id integer not null, owner_oid varchar(36) not null, policy integer, targetRef_relation varchar(157), targetRef_targetOid varchar(36), targetRef_type integer, primary key (id, owner_oid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ENGINE=InnoDB;
...
alter table m_assignment_ext_long add constraint fk_assignment_ext_long foreign key (anyContainer_owner_id, anyContainer_owner_owner_oid) references m_assignment_extension (owner_id, owner_owner_oid);
...
alter table m_object_ext_boolean add constraint fk_object_ext_boolean foreign key (owner_oid) references m_object (oid);
alter table m_object_ext_date add constraint fk_object_ext_date foreign key (owner_oid) references m_object (oid);
alter table m_object_ext_long add constraint fk_object_ext_long foreign key (owner_oid) references m_object (oid);
alter table m_object_ext_poly add constraint fk_object_ext_poly foreign key (owner_oid) references m_object (oid);
alter table m_object_ext_reference add constraint fk_object_ext_reference foreign key (owner_oid) references m_object (oid);
...
alter table m_exclusion add constraint fk_exclusion_owner foreign key (owner_oid) references m_object (oid);
