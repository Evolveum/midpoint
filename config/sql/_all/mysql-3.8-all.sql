...
create table m_object_ext_boolean (item_id integer not null, owner_oid varchar(36) not null, ownerType integer not null, booleanValue bit not null, primary key (owner_oid, ownerType, item_id, booleanValue)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
create table m_object_ext_date (item_id integer not null, owner_oid varchar(36) not null, ownerType integer not null, dateValue datetime(6) not null, primary key (owner_oid, ownerType, item_id, dateValue)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
create table m_object_ext_long (item_id integer not null, owner_oid varchar(36) not null, ownerType integer not null, longValue bigint not null, primary key (owner_oid, ownerType, item_id, longValue)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
create table m_object_ext_poly (item_id integer not null, owner_oid varchar(36) not null, ownerType integer not null, orig varchar(255) not null, norm varchar(255), primary key (owner_oid, ownerType, item_id, orig)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
create table m_object_ext_reference (item_id integer not null, owner_oid varchar(36) not null, ownerType integer not null, targetoid varchar(36) not null, relation varchar(157), targetType integer, primary key (owner_oid, ownerType, item_id, targetoid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
create table m_object_ext_string (item_id integer not null, owner_oid varchar(36) not null, ownerType integer not null, stringValue varchar(255) not null, primary key (owner_oid, ownerType, item_id, stringValue)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
create table m_object_subtype (object_oid varchar(36) not null, subType varchar(255)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
...
create table m_org (displayOrder integer, name_norm varchar(255), name_orig varchar(255), tenant bit, oid varchar(36) not null, primary key (oid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
...
create table m_service (displayOrder integer, name_norm varchar(255), name_orig varchar(255), oid varchar(36) not null, primary key (oid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_bin engine=InnoDB;
...
alter table m_object_subtype add constraint fk_object_subtype foreign key (object_oid) references m_object (oid);
