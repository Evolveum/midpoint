...
create table m_exclusion (id int4 not null, owner_oid varchar(36) not null, policy int4, targetRef_relation varchar(157), targetRef_targetOid varchar(36), targetRef_type int4, primary key (id, owner_oid));
