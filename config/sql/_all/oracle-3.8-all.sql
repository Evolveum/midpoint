...
create table m_object_subtype (object_oid varchar2(36 char) not null, subType varchar2(255 char)) initrans 30;
...
create table m_org (displayOrder number(10,0), name_norm varchar2(255 char), name_orig varchar2(255 char), tenant number(1,0), oid varchar2(36 char) not null, primary key (oid)) initrans 30;
...
create table m_service (displayOrder number(10,0), name_norm varchar2(255 char), name_orig varchar2(255 char), oid varchar2(36 char) not null, primary key (oid)) initrans 30;
...
create index iLocality on m_focus (locality_orig) initrans 30;
