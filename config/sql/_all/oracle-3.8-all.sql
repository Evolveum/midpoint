...
create table m_assignment_ext_boolean (item_id number(10,0) not null, anyContainer_owner_id number(10,0) not null, anyContainer_owner_owner_oid varchar2(36 char) not null, booleanValue number(1,0) not null, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, booleanValue)) initrans 30;
create table m_assignment_ext_date (item_id number(10,0) not null, anyContainer_owner_id number(10,0) not null, anyContainer_owner_owner_oid varchar2(36 char) not null, dateValue timestamp not null, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, dateValue)) initrans 30;
create table m_assignment_ext_long (item_id number(10,0) not null, anyContainer_owner_id number(10,0) not null, anyContainer_owner_owner_oid varchar2(36 char) not null, longValue number(19,0) not null, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, longValue)) initrans 30;
create table m_assignment_ext_poly (item_id number(10,0) not null, anyContainer_owner_id number(10,0) not null, anyContainer_owner_owner_oid varchar2(36 char) not null, orig varchar2(255 char) not null, norm varchar2(255 char), primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, orig)) initrans 30;
create table m_assignment_ext_reference (item_id number(10,0) not null, anyContainer_owner_id number(10,0) not null, anyContainer_owner_owner_oid varchar2(36 char) not null, targetoid varchar2(36 char) not null, relation varchar2(157 char), targetType number(10,0), primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, targetoid)) initrans 30;
create table m_assignment_ext_string (item_id number(10,0) not null, anyContainer_owner_id number(10,0) not null, anyContainer_owner_owner_oid varchar2(36 char) not null, stringValue varchar2(255 char) not null, primary key (item_id, anyContainer_owner_id, anyContainer_owner_owner_oid, stringValue)) initrans 30;
...
create table m_object_ext_boolean (item_id number(10,0) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, booleanValue number(1,0) not null, primary key (item_id, owner_oid, ownerType, booleanValue)) initrans 30;
create table m_object_ext_date (item_id number(10,0) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, dateValue timestamp not null, primary key (item_id, owner_oid, ownerType, dateValue)) initrans 30;
create table m_object_ext_long (item_id number(10,0) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, longValue number(19,0) not null, primary key (item_id, owner_oid, ownerType, longValue)) initrans 30;
create table m_object_ext_poly (item_id number(10,0) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, orig varchar2(255 char) not null, norm varchar2(255 char), primary key (item_id, owner_oid, ownerType, orig)) initrans 30;
create table m_object_ext_reference (item_id number(10,0) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, targetoid varchar2(36 char) not null, relation varchar2(157 char), targetType number(10,0), primary key (item_id, owner_oid, ownerType, targetoid)) initrans 30;
create table m_object_ext_string (item_id number(10,0) not null, owner_oid varchar2(36 char) not null, ownerType number(10,0) not null, stringValue varchar2(255 char) not null, primary key (item_id, owner_oid, ownerType, stringValue)) initrans 30;
...
create index iExtensionString on m_object_ext_boolean (booleanValue) initrans 30;
create index iExtensionString on m_object_ext_date (dateValue) initrans 30;
create index iExtensionString on m_object_ext_long (longValue) initrans 30;
create index iExtensionString on m_object_ext_poly (orig) initrans 30;
create index iExtensionString on m_object_ext_reference (targetoid) initrans 30;
