...
create table m_audit_delta (checksum varchar(32) not null, record_id bigint not null, delta clob, deltaOid varchar(36), deltaType integer, fullResult clob, objectName_norm varchar(255), objectName_orig varchar(255), resourceName_norm varchar(255), resourceName_orig varchar(255), resourceOid varchar(36), status integer, primary key (checksum, record_id));
...
create table m_object_ext_boolean (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, booleanValue boolean not null, dynamicDef boolean, eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, booleanValue));
create table m_object_ext_date (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, dateValue timestamp not null, dynamicDef boolean, eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, dateValue));
create table m_object_ext_long (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, longValue bigint not null, dynamicDef boolean, eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, longValue));
create table m_object_ext_poly (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, orig varchar(255) not null, dynamicDef boolean, norm varchar(255), eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, orig));
create table m_object_ext_reference (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, targetoid varchar(36) not null, dynamicDef boolean, relation varchar(157), targetType integer, eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, targetoid));
create table m_object_ext_string (eName varchar(157) not null, owner_oid varchar(36) not null, ownerType integer not null, stringValue varchar(255) not null, dynamicDef boolean, eType varchar(157), valueType integer, primary key (eName, owner_oid, ownerType, stringValue));
