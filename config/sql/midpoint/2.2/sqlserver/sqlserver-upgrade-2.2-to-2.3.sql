...
CREATE INDEX iObjectNameNorm ON m_object (name_norm);
 ...
 ALTER TABLE m_authorization ADD objectSpecification NVARCHAR(MAX);
...
ALTER TABLE m_focus ADD iteration INT;
ALTER TABLE m_focus ADD iterationToken NVARCHAR(255);
