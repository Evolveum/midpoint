...
CREATE OR REPLACE FUNCTION m_shadow_create_partition() RETURNS trigger AS $BODY$
    ...
    EXECUTE format('ALTER TABLE m_shadow DISABLE TRIGGER m_shadow_oid_delete_tr;', sourceTable);
      IF new.objectClassId IS NULL THEN
      ...
      EXECUTE format('ALTER TABLE m_shadow ENABLE TRIGGER m_shadow_oid_delete_tr;', sourceTable);
