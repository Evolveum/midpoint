...
//    @NotNull
//    <F extends FocusType> List<PrismObject<F>> findFocusesByCorrelationRule(Class<F> focusType, ShadowType currentShadow,
...
//
//        SynchronizationPolicy synchronizationPolicy = syncCtx.getSynchronizationPolicy();
