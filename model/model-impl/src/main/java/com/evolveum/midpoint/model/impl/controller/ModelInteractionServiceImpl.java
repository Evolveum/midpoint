    ...
    public <O extends ObjectType> MergeDeltas<O> mergeObjectsPreviewDeltas(Class<O> type, String leftOid,
        ...
        try {
            ...
            return mergeDeltas;
                ...
                CommunicationException | SecurityViolationException | RuntimeException | Error | RestrictedObjectException e) {
            result.recordFatalError(e);
            throw e;
        }
    }
