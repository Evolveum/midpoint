    ...
    private void processResourceMappings(DataModel model, List<PrismObject<ResourceType>> resources)
        ...
        for (PrismObject<ResourceType> resource : resources) {
            ...
            for (ResourceObjectTypeDefinition refinedDefinition : refinedDefinitions) {
                ...
                Collection<? extends ShadowSimpleAttributeDefinition<?>> attributeDefinitions = refinedDefinition.getAttributeDefinitions();
                ...
                for (ShadowReferenceAttributeDefinition associationDefinition : refinedDefinition.getAssociationDefinitions()) {
