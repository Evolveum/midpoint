...
public class ExclusionRequirementConstraintEvaluator
    ...
    private <AH extends AssignmentHolderType> LocalizableMessage createShortMessage(LocalizableMessage infoA, Object infoB,
            ...
            throws ExpressionEvaluationException, ObjectNotFoundException, SchemaException, CommunicationException, ConfigurationException, SecurityViolationException, RestrictedObjectException {
        LocalizableMessage builtInMessage = new LocalizableMessageBuilder()
