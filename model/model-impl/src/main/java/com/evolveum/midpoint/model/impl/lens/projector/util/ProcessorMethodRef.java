...
public interface ProcessorMethodRef<X extends ObjectType> {
    ...
    void run(LensContext<X> lensContext, String activityDescription, XMLGregorianCalendar now, Task task, OperationResult result) throws SchemaException, ObjectNotFoundException, CommunicationException, ConfigurationException,
