 ...
 */
@Experimental
public class SynchronizationObjectsFilter {
    ...
    public SynchronizationObjectsFilter(@NotNull ObjectClassComplexTypeDefinition objectClassDefinition, ShadowKindType kind, String intent) {
    ...
    public ObjectQuery createShadowSearchQuery(String resourceOid) throws SchemaException {
        return objectClassDefinition.createShadowSearchQuery(resourceOid);
    }
