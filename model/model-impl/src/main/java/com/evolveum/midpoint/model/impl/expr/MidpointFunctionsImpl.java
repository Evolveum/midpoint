...
public class MidpointFunctionsImpl implements MidpointFunctions {
    ...
    public String createInvitationLink(UserType user) {
        try {
            ...
            String invitationSequenceId = SecurityUtil.getInvitationSequenceName(securityPolicy);
    ...
    private String getNonceCredentialsPolicyName(UserType user, Task task, OperationResult result) throws
        ...
        String sequenceIdentifier = SecurityUtil.getInvitationSequenceName(securityPolicy);
        ...
        String moduleName = module.getName() != null ? module.getName() : module.getName();
        ...
        MailNonceAuthenticationModuleType invitationAuthModule = securityPolicy.getAuthentication()
                ...
                .getMailNonce()
                .stream()
                .filter(m -> moduleNameMatch(m, moduleName))
                .findFirst()
                .orElse(null);
    ...
    private boolean sequenceIdentifierMatch(AuthenticationSequenceType seq, String sequenceName) {
        return sequenceName.equals(seq.getName()) || sequenceName.equals(seq.getName());
    }

    private boolean moduleNameMatch(MailNonceAuthenticationModuleType module, String moduleName) {
        if (moduleName == null) {
            return false;
        }
        return moduleName.equals(module.getName());
    }
    @Override
