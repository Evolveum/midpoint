...
public class SmartAssignmentElement implements DebugDumpable {
    ...
    void updateOrigin(SmartAssignmentCollection.Mode mode, AddDeleteReplace deltaSet, boolean inDelta) {
        origin.update(mode, deltaSet, inDelta);
    }
