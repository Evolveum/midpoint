...
public class ObjectIntegrityCheckActivityExecution
    ...
    public ObjectIntegrityCheckActivityExecution(ObjectIntegrityCheckTaskHandler.TaskExecution taskExecution) {
        super(taskExecution);
