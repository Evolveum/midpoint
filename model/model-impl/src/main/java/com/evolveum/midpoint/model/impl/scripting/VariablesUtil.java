...
public class VariablesUtil {
	...
	private static TypedValue variableFromPathExpression(VariablesMap resultingVariables,
		...
		return ExpressionUtil.resolvePathGetValueAndDefinition(itemPath, createVariables(resultingVariables), false, null, ctx.objectResolver, ctx.prismContext, shortDesc, ctx.task, result);
	}
