 ...
 */
@ItemProcessorClass(RemainingShadowsActivityExecution.ItemProcessor.class)
...
class RemainingShadowsActivityExecution
        ...
        <ShadowType,
                ...
                RemainingShadowsActivityExecution.ItemProcessor> {

    RemainingShadowsActivityExecution(ReconciliationTaskExecution taskExecution) {
        super(taskExecution);
        ...
        setActivityIdentifier(ModelPublicConstants.RECONCILIATION_REMAINING_SHADOWS_PART_URI);
