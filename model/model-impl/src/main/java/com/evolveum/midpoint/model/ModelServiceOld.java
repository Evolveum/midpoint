 ...
 */
@Deprecated
public class ModelServiceOld implements ModelPortType {

	@Autowired(required = true)
	private ProvisioningPortType provisioningService;
	@Autowired(required = true)
	private RepositoryPortType repositoryService;
	private static final transient Trace logger = TraceManager.getTrace(ModelServiceOld.class);
	@Autowired(required = true)
	 ...
	 */
	@Override
	public void testResource(String resourceOid, Holder<OperationResultType> resultType) throws FaultMessage {
		notNullArgument(resultType, "Result type must not be null.");
