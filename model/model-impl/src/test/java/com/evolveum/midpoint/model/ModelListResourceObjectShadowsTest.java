...
public class ModelListResourceObjectShadowsTest {
    ...
    public void emptyShadowType() throws FaultMessage {
        modelService.listResourceObjectShadows("1", "");
        fail("Illegal argument excetion must be thrown");
    }
    ...
    public void nonexistingResourceOid() throws FaultMessage,
        ...
        when(repositoryService.listResourceObjectShadows(resourceOid, Utils.getObjectType("AccountType"))).thenThrow(
    ...
    public void badResourceShadowType() throws FaultMessage {
        modelService.listResourceObjectShadows("abababab-abab-abab-abab-000000000001",
                Utils.getObjectType("GenericObjectType"));
    ...
    public void correctList() throws FaultMessage, JAXBException,
        ...
        final String resourceOid = "abababab-abab-abab-abab-000000000001";
        final ResourceObjectShadowListType expected = ((JAXBElement<ResourceObjectShadowListType>) JAXBUtil.unmarshal(
                new File(TEST_FOLDER, "resource-object-shadow-list.xml"))).getValue();
        trace.warn("TODO: File resource-object-shadow-list.xml doesn't contain proper resource object shadow list.");

        when(repositoryService.listResourceObjectShadows(resourceOid, Utils.getObjectType("AccountType"))).thenReturn(expected);

        final ResourceObjectShadowListType returned = modelService.listResourceObjectShadows(
                resourceOid, Utils.getObjectType("AccountType"));
    ...
    private void testShadowListType(ResourceObjectShadowListType expected, ResourceObjectShadowListType returned) {
