...
public class TestFilterResolverQueryDsl extends AbstractInternalModelIntegrationTest {
    ...
    private static final File RESOURCE_DUMMY_DEPENDENCY_FILTER_FILE = new File(TEST_DIR, "resource-dummy-dependency-filter-querydsl.xml");
