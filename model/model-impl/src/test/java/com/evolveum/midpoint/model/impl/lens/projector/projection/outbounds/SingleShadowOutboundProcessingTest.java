...
public class SingleShadowOutboundProcessingTest extends AbstractEmptyInternalModelTest {
    ...
    private SingleShadowOutboundProcessing outboundProcessing;
    ...
    public void instantiateSut() {
        this.outboundProcessing = new SingleShadowOutboundProcessing(this.mappingFactory, this.mappingEvaluator,
                this.clock);
    }
