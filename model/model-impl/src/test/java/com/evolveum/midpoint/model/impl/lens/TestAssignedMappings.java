...
public class TestAssignedMappings extends AbstractLensTest {
    ...
    private static final TestObject<RoleType> ROLE_SIMPLE = TestObject.file(TEST_DIR, "role-simple.xml", "de0c9c11-eb2e-4b6a-9200-a4306a5c8d6c");
    private static final TestObject<UserType> USER_JIM = TestObject.file(TEST_DIR, "user-jim.xml", "6ce717d6-414f-4d91-948a-923f02191399");

    private static final TestObject<RoleType> METAMETAROLE_MMR111 = TestObject.file(TEST_DIR, "metametarole-mmr1.1.1.xml", "b3d1cb95-526b-4162-8d65-acd8f2994644");
    private static final TestObject<RoleType> METAMETAROLE_MMR112 = TestObject.file(TEST_DIR, "metametarole-mmr1.1.2.xml", "49cf021c-4127-41e1-9187-abcbeb8c0903");
    private static final TestObject<RoleType> METAMETAROLE_MMR113 = TestObject.file(TEST_DIR, "metametarole-mmr1.1.3.xml", "99ed5447-4633-40ca-a81d-faa6f364ee69");
    private static final TestObject<RoleType> METAMETAROLE_MMR121 = TestObject.file(TEST_DIR, "metametarole-mmr1.2.1.xml", "786f30f5-083f-4e45-a06d-2213a8cbd789");
    private static final TestObject<RoleType> METAMETAROLE_MMR122 = TestObject.file(TEST_DIR, "metametarole-mmr1.2.2.xml", "9fcb61b5-d970-4637-8cbe-6ffbaf075ab4");
    private static final TestObject<RoleType> METAMETAROLE_MMR123 = TestObject.file(TEST_DIR, "metametarole-mmr1.2.3.xml", "717c386e-4fd0-48c7-982b-ccdbb8d4415e");
    private static final TestObject<RoleType> METAMETAROLE_MMR131 = TestObject.file(TEST_DIR, "metametarole-mmr1.3.1.xml", "7f9239aa-e2ea-4532-a597-6cb572dadd6b");
    private static final TestObject<RoleType> METAMETAROLE_MMR132 = TestObject.file(TEST_DIR, "metametarole-mmr1.3.2.xml", "c5f74a67-da40-4498-a2f9-1d41ff4163b6");
    private static final TestObject<RoleType> METAMETAROLE_MMR211 = TestObject.file(TEST_DIR, "metametarole-mmr2.1.1.xml", "01f0ae41-6348-4707-ab17-a0638302d759");
    private static final TestObject<RoleType> METAMETAROLE_MMR221 = TestObject.file(TEST_DIR, "metametarole-mmr2.2.1.xml", "0f4ff4db-53d9-4028-9995-6fa6f1d2fbfe");
    private static final TestObject<RoleType> METAMETAROLE_MMR231 = TestObject.file(TEST_DIR, "metametarole-mmr2.3.1.xml", "eda583e0-7f6f-4770-ba59-a7a9fbbb2fa6");
    private static final TestObject<RoleType> METAMETAROLE_MMR241 = TestObject.file(TEST_DIR, "metametarole-mmr2.4.1.xml", "06ce4987-6e3a-4e61-9ec3-f436b15ef7b1");
    private static final TestObject<RoleType> METAMETAROLE_MMR311 = TestObject.file(TEST_DIR, "metametarole-mmr3.1.1.xml", "46fe813b-2658-4f49-b67e-1516b7154851");

    private static final TestObject<RoleType> METAROLE_MR11 = TestObject.file(TEST_DIR, "metarole-mr1.1.xml", "2f4136cd-663f-4d52-bc29-77dd6cc64bda");
    private static final TestObject<RoleType> METAROLE_MR12 = TestObject.file(TEST_DIR, "metarole-mr1.2.xml", "4106cf9e-443e-4218-9aef-88d7d9aac3e4");
    private static final TestObject<RoleType> METAROLE_MR13 = TestObject.file(TEST_DIR, "metarole-mr1.3.xml", "a92858ac-52cc-4ea7-aa42-0fb3033ac9f2");
    private static final TestObject<RoleType> METAROLE_MR21 = TestObject.file(TEST_DIR, "metarole-mr2.1.xml", "e0cf0c0e-0db4-4d41-bba4-5e6ee4928837");
    private static final TestObject<RoleType> METAROLE_MR22 = TestObject.file(TEST_DIR, "metarole-mr2.2.xml", "cfda5d1a-c940-4648-a362-d49195ee2d17");
    private static final TestObject<RoleType> METAROLE_MR23 = TestObject.file(TEST_DIR, "metarole-mr2.3.xml", "3108290d-08c5-4025-a574-32998da7e28c");
    private static final TestObject<RoleType> METAROLE_MR24 = TestObject.file(TEST_DIR, "metarole-mr2.4.xml", "559efdde-90e0-465b-8989-a45472f14c9f");
    private static final TestObject<RoleType> METAROLE_MR31 = TestObject.file(TEST_DIR, "metarole-mr3.1.xml", "1b732c09-ecf0-41d6-828a-1cbeba9d4758");
    private static final TestObject<RoleType> METAROLE_MR32 = TestObject.file(TEST_DIR, "metarole-mr3.2.xml", "59ae7541-cdb0-4d71-99ad-2df4130d5833");
    private static final TestObject<RoleType> METAROLE_MR33 = TestObject.file(TEST_DIR, "metarole-mr3.3.xml", "9af8fcad-05e2-46c0-9e0c-31c037931a32");
    private static final TestObject<RoleType> METAROLE_MR41 = TestObject.file(TEST_DIR, "metarole-mr4.1.xml", "b2876ccd-ed84-40f4-9841-f694a0722196");
    private static final TestObject<RoleType> METAROLE_MR51 = TestObject.file(TEST_DIR, "metarole-mr5.1.xml", "7323da3b-4657-42f7-8e92-0dd27c34f4fd");
    private static final TestObject<RoleType> METAROLE_MR61 = TestObject.file(TEST_DIR, "metarole-mr6.1.xml", "2bb624c8-1d55-4fd4-9c1b-a3e51c6a572a");

    private static final TestObject<RoleType> ROLE_R1 = TestObject.file(TEST_DIR, "role-r1.xml", "b6897584-6b3e-421c-b4f3-b57123eac50c");
    private static final TestObject<RoleType> ROLE_R2 = TestObject.file(TEST_DIR, "role-r2.xml", "e502a2b9-6961-42f6-91dd-f45edc6e2b02");
    private static final TestObject<RoleType> ROLE_R3 = TestObject.file(TEST_DIR, "role-r3.xml", "7fc1925f-6e54-47a8-aa4b-65b1903d65eb");
    private static final TestObject<RoleType> ROLE_R4 = TestObject.file(TEST_DIR, "role-r4.xml", "958d0b7b-146f-4c25-aee1-ae27d26e34ed");
    private static final TestObject<RoleType> ROLE_R5 = TestObject.file(TEST_DIR, "role-r5.xml", "beb37147-f75a-4c44-a9ec-bc482c1e2a85");
    private static final TestObject<RoleType> ROLE_R6 = TestObject.file(TEST_DIR, "role-r6.xml", "5c58ec3c-bb67-423c-ac4b-bb276c2e8c92");

    private static final TestObject<UserType> USER_ADAM = TestObject.file(TEST_DIR, "user-adam.xml", "cf10f112-a731-45cd-8dfb-1b3fe9375c14");
    private static final TestObject<UserType> USER_BENJAMIN = TestObject.file(TEST_DIR, "user-benjamin.xml", "2e1a427c-d6a7-4783-90ec-9dc0ebc98630");

    private static final TestObject<UserType> USER_FRODO = TestObject.file(TEST_DIR, "user-frodo.xml", "786919b7-23c9-4a38-90e7-5a1efd0ab853");
    private static final TestObject<RoleType> ROLE_BEARABLE = TestObject.file(TEST_DIR, "metarole-bearable.xml", "2421b2c5-8563-4ba7-9a87-f9ef4b169620");
    private static final TestObject<ServiceType> SERVICE_RING = TestObject.file(TEST_DIR, "service-ring.xml", "7540cf28-a143-4eea-9379-75cae5d212cb");
    private static final TestObject<ServiceType> SERVICE_STING = TestObject.file(TEST_DIR, "service-sting.xml", "f8b109bf-d393-47b9-8eec-41d74e39a992");
    private static final TestObject<RoleType> ROLE_PROPAGATOR = TestObject.file(TEST_DIR, "role-propagator.xml", "8e56a98a-bcb9-4178-94f2-5488da473132");
    ...
    private AssignmentType createRoleAssignment(TestObject<?> role) {
    ...
    @SuppressWarnings("SameParameterValue")
    private AssignmentType createRoleAssignmentDisabled(TestObject<?> role) {
        return new AssignmentType()
                .targetRef(role.oid, RoleType.COMPLEX_TYPE)
                .beginActivation()
