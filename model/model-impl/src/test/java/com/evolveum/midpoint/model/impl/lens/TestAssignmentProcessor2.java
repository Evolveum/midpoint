...
//				getDummyResourceController().getAttributeQName(DummyResourceContoller.DUMMY_ACCOUNT_ATTRIBUTE_LOCATION_NAME), "Caribbean");
	...
	private void disableRoles(String rolesText) {
		List<String> roleNames = getList(rolesText);
	...
	@Test
	public void test200DisableSomeAssignments() throws Exception {
		final String TEST_NAME = "test200DisableSomeAssignments";
		TestUtil.displayTestTile(this, TEST_NAME);
