...
public class TestInbounds extends AbstractInitializedModelIntegrationTest {
    ...
    public void test101ModifyUserSubtypePirate() throws Exception {
        ...
        ObjectDelta<UserType> userDelta = prismContext.deltaFactory().object().createModificationReplaceProperty(
                UserType.class, USER_JACK_OID, UserType.F_SUBTYPE, "PIRATE");
        // Make sure that the user has no employeeNumber so it will be generated by inbound mapping in the green resource
        userDelta.addModificationReplaceProperty(UserType.F_EMPLOYEE_NUMBER);
        userDelta.addModificationAddProperty(
    ...
    public void test202ModifyAccountOrangeGossip() throws Exception {
        ...
        var userAfter = assertUserAfter(USER_GUYBRUSH_OID)
                .assignments()
                .assertAssignments(2)
                .by().accountOn(RESOURCE_DUMMY_ORANGE_OID).find().end()
                .by().roleOid(ROLE_PIRATE_OID).find()
                .assertOriginMappingName("gossip-inbound")
                .end()
                .end()
                .assertLiveLinks(2)
                .getObject();
    ...
    public void test252ModifyAccountOrangeGossipRecon() throws Exception {
        ...
        invalidateShadowCacheIfNeeded(RESOURCE_DUMMY_ORANGE_OID);
