...
public class TestAsyncUpdateTaskMechanics extends AbstractConfiguredModelIntegrationTest {
    ...
    @Test
    public void test100SmallTaskNoWorkers() throws IOException, TimeoutException, CommonException, JMSException, NamingException {
        Task task = getTestTask();
    ...
    @Test
    public void test110SmallTaskOneWorker() throws IOException, TimeoutException, CommonException, JMSException, NamingException {
        Task task = getTestTask();
        OperationResult result = task.getResult();
    ...
    private void prepareMessages(File templateFile, String prefix, int howMany, boolean markLast)
            throws IOException, TimeoutException, JMSException, NamingException {
