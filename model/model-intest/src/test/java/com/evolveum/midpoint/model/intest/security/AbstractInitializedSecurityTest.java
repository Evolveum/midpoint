...
public abstract class AbstractInitializedSecurityTest extends AbstractInitializedModelIntegrationTest {
    ...
    protected static final TestObject<RoleType> SERVICE_RISK_HIGH = TestObject.file(TEST_DIR, "service-risk-high.xml", "2ef9a343-d293-4bf8-852f-ff22a6d43509");
    ...
    protected static final TestObject<AccessCertificationCampaignType> CAMPAIGN4 = TestObject.file(TEST_DIR, "access-certification-campaign-4.xml", "e3212c2f-d61f-4176-a35d-132a9f575a70");
    ...
    public void initSystem(Task initTask, OperationResult initResult) throws Exception {
        ...
        repoAdd(SERVICE_RISK_HIGH, initResult);
    ...
    protected void assertModifyDeny() throws ObjectAlreadyExistsException, ObjectNotFoundException, SchemaException, ExpressionEvaluationException, CommunicationException, ConfigurationException, PolicyViolationException, RestrictedObjectException {
    ...
    protected void assertModifyDenyRaw() throws ObjectAlreadyExistsException, ObjectNotFoundException, SchemaException, ExpressionEvaluationException, CommunicationException, ConfigurationException, PolicyViolationException, RestrictedObjectException {
    ...
    protected void assertModifyAllow() throws ObjectAlreadyExistsException, ObjectNotFoundException, SchemaException, ExpressionEvaluationException, CommunicationException, ConfigurationException, PolicyViolationException, SecurityViolationException, RestrictedObjectException {
        // self-modify, common property
    ...
    protected void assertModifyAllowRaw() throws ObjectAlreadyExistsException, ObjectNotFoundException, SchemaException, ExpressionEvaluationException, CommunicationException, ConfigurationException, PolicyViolationException, SecurityViolationException, RestrictedObjectException {
    ...
    protected <O extends ObjectType> void assertModifyMetadataDeny(Class<O> type, String oid) throws ObjectAlreadyExistsException, ObjectNotFoundException, SchemaException, ExpressionEvaluationException, CommunicationException, ConfigurationException, PolicyViolationException, RestrictedObjectException {
    ...
    protected <O extends ObjectType> void assertPasswordChangeDeny(Class<O> type, String oid, String newPassword) throws ObjectAlreadyExistsException, ObjectNotFoundException, SchemaException, ExpressionEvaluationException, CommunicationException, ConfigurationException, PolicyViolationException, RestrictedObjectException {
    ...
    protected <O extends ObjectType> void assertPasswordChangeAllow(Class<O> type, String oid, String newPassword) throws ObjectAlreadyExistsException, ObjectNotFoundException, SchemaException, ExpressionEvaluationException, CommunicationException, ConfigurationException, PolicyViolationException, SecurityViolationException, RestrictedObjectException {
        ProtectedStringType passwordPs = new ProtectedStringType();
        passwordPs.setClearValue(newPassword);
    ...
    protected <O extends ObjectType> void assertModifyDenyOptions(
            ...
            CommunicationException, ConfigurationException, PolicyViolationException, RestrictedObjectException {
