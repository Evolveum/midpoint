        ...
        assertUserAfter(findUserByUsernameFullRequired("white1"))
                ...
                .identities()
                    .fromResource(RESOURCE_SINGLE.oid, ShadowKindType.ACCOUNT, "default", null)
                        .assertDataItem(UserType.F_GIVEN_NAME, PolyString.fromOrig("Bob"))
                        .assertDataItem(UserType.F_FAMILY_NAME, PolyString.fromOrig("White"))
    ...
    public void test130ImportAccountChuckFromVariousSources() throws Exception {
        ...
        assertUserAfter(findUserByUsernameFullRequired("brown1"))
                ...
                .identities()
                    .fromResource(RESOURCE_MULTI.oid, ShadowKindType.ACCOUNT, "default", "10700020")
                        .assertDataItem(UserType.F_GIVEN_NAME, PolyString.fromOrig("Chuck"))
                        .assertDataItem(UserType.F_FAMILY_NAME, PolyString.fromOrig("Brown"))
        ...
        assertUserAfter(findUserByUsernameFullRequired("brown1"))
                ...
                .identities()
                    ...
                    .fromResource(RESOURCE_MULTI.oid, ShadowKindType.ACCOUNT, "default", "10700010")
                        .assertDataItem(UserType.F_GIVEN_NAME, PolyString.fromOrig("Charles"))
                        .assertDataItem(UserType.F_FAMILY_NAME, PolyString.fromOrig("Brown"))
                        .assertDataItem(PATH_PERSONAL_NUMBER, "1004444")
                    .end()
                    .normalizedData()
        ...
        assertUserAfter(findUserByUsernameFullRequired("brown1"))
                ...
                .identities()
                    ...
                    .end()
                    .fromResource(RESOURCE_SINGLE.oid, ShadowKindType.ACCOUNT, "default", null)
                        .assertDataItem(UserType.F_GIVEN_NAME, PolyString.fromOrig("Karl"))
                        .assertDataItem(UserType.F_FAMILY_NAME, PolyString.fromOrig("Brown"))
                        .assertDataItem(PATH_PERSONAL_NUMBER, "1004444")
                    .end()
                    .normalizedData()
