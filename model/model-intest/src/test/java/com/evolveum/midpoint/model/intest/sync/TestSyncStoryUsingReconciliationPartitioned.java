...
public class TestSyncStoryUsingReconciliationPartitioned extends TestSyncStoryUsingReconciliation {

    protected static final String TASK_RECONCILE_DUMMY_PARTITIONED_FILENAME = COMMON_DIR + "/task-reconcile-dummy-partitioned.xml";
    protected static final String TASK_RECONCILE_DUMMY_PARTITIONED_OID = "10000000-0000-0000-565b-565600000004";
    ...
    protected static final String TASK_RECONCILE_DUMMY_BLUE_PARTITIONED_OID = "10000000-0000-0000-565b-565600000204";
    ...
    protected static final String TASK_RECONCILE_DUMMY_GREEN_PARTITIONED_OID = "10000000-0000-0000-565b-565600000404";
