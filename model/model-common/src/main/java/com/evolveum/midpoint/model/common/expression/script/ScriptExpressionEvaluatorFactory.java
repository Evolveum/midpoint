...
public class ScriptExpressionEvaluatorFactory extends AbstractAutowiredExpressionEvaluatorFactory {
	...
	public <V extends PrismValue,D extends ItemDefinition> ExpressionEvaluator<V,D> createEvaluator(Collection<JAXBElement<?>> evaluatorElements,
			D outputDefinition, ExpressionProfile expressionProfile, ExpressionFactory factory, String contextDescription, Task task, OperationResult result) throws SchemaException {
        ...
        return new ScriptExpressionEvaluator<>(scriptType, scriptExpression, expressionProfile, securityContextManager, localizationService, prismContext);
