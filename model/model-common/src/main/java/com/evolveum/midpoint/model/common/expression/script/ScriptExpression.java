...
public class ScriptExpression {
	...
	public <T> List<PrismValue> evaluate(ExpressionVariables variables, ScriptExpressionReturnTypeType suggestedReturnType, 
		...
		try {
			...
			List<PrismValue> expressionResult = evaluator.evaluate(scriptType, variables, outputDefinition, suggestedReturnType, objectResolver, functions, contextDescription, result);
