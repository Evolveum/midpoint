...
// */
//@Component
//public class UserPasswordNotifier implements EventHandler, Notifier {
//
...
//
//    @Override
//    public void notify(Event request,
...
//
//      // todo todo todo
////        List<ObjectDelta<AccountShadowType>> accountDeltas = (List<ObjectDelta<AccountShadowType>>) event.getParameter(NotificationConstants.ACCOUNT_DELTAS);
////        ModelContext<UserType, AccountShadowType> modelContext = (ModelContext<UserType, AccountShadowType>) event.getParameter(NotificationConstants.MODEL_CONTEXT);
////
////        List<QName> situations = notificationConfigurationEntry.getSituation();
////
////        StringBuilder messageText = prepareMessageText(event, accountDeltas, modelContext, situations);
////
...
//    }
//
//    private StringBuilder prepareMessageText(Event request, List<ObjectDelta<ShadowType>> accountDeltas, ModelContext<UserType, ShadowType> modelContext, List<QName> situations) {
