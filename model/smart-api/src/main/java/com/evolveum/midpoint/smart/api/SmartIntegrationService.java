...
public interface SmartIntegrationService {
    ...
    String regenerateObjectClassStatistics(String resourceOid, QName objectClassName, Integer threads, Task task, OperationResult result)
            throws CommonException;

    /** Regenerates statistics for the given resource object type. */
    String regenerateObjectTypeStatistics(String resourceOid, ResourceObjectTypeIdentification resourceObjectTypeIdentification, Integer threads, Task task, OperationResult result)
            throws CommonException;
