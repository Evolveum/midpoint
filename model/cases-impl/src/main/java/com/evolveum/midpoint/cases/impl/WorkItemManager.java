...
public class WorkItemManager {
    ...
    public void completeWorkItem(WorkItemId workItemId, @NotNull AbstractWorkItemOutputType output,
            ...
            ConfigurationException, SchemaException, ObjectAlreadyExistsException, RestrictedObjectException {
    ...
    void completeWorkItems(CompleteWorkItemsRequest request, Task task, OperationResult parentResult)
        ...
        try {
            caseEngine.executeRequest(request, task, result);
                ...
                SchemaException | ObjectAlreadyExistsException | RestrictedObjectException e) {
    ...
    void delegateWorkItem(
            ...
            Task task,
            OperationResult parentResult)
            throws ObjectNotFoundException, SecurityViolationException, SchemaException, ExpressionEvaluationException, CommunicationException, ConfigurationException, RestrictedObjectException {
        ...
        try {
            ...
            caseEngine.executeRequest(request, task, result);
                ...
                CommunicationException | ConfigurationException | RestrictedObjectException e) {
