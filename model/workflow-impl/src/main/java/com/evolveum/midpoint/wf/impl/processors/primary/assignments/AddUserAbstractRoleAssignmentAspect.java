 ...
 */
@Component
public class AddUserAbstractRoleAssignmentAspect extends AddAbstractRoleAssignmentAspect<UserType> {

    private static final Trace LOGGER = TraceManager.getTrace(AddUserAbstractRoleAssignmentAspect.class);
