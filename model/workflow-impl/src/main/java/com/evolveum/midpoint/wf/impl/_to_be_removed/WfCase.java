 ...
 */
package com.evolveum.midpoint.wf.impl._to_be_removed;
...
//    WfCase(WfTaskController wfTaskController, Task task, ChangeProcessor changeProcessor) {
//        this(wfTaskController, task, null, changeProcessor);
//    }
//
//    protected WfCase(@NotNull WfTaskController wfTaskController, @NotNull CaseType aCase, @NotNull ChangeProcessor changeProcessor) {
//        this.wfTaskController = wfTaskController;
//        this.aCase = aCase;
//        this.changeProcessor = changeProcessor;
//    }
//
//    protected WfCase(WfCase original) {
//        this.wfTaskController = original.wfTaskController;
//        this.aCase = original.aCase;
...
//    }
//
//    public List<WfCase> listChildren(OperationResult result) throws SchemaException {
//        List<WfCase> wfTasks = new ArrayList<>();
...
//    }
//
//    public List<WfCase> listDependents(OperationResult result) throws SchemaException, ObjectNotFoundException {
//        List<WfCase> wfTasks = new ArrayList<>();
//        for (Task subtask : task.listDependents(result)) {
//            wfTasks.add(wfTaskController.recreateWfCase(subtask));
//        }
//        return wfTasks;
//    }
//
//    public WfCase getParentJob(OperationResult result) throws SchemaException, ObjectNotFoundException {
//        Task parentTask = task.getParentTask(result);
//        return wfTaskController.recreateWfCase(parentTask);
//    }
//
...
//    }
//
//    public void addPrerequisites(@NotNull List<CaseType> prerequisites) {
