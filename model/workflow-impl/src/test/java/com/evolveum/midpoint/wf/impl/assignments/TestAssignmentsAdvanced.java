...
public class TestAssignmentsAdvanced extends AbstractWfTestPolicy {
    ...
    private static final TestResource ROLE_BEING_ENABLED = new TestResource(TEST_RESOURCE_DIR, "role-being-enabled.xml", "4fcf187a-09b7-4d32-b998-9cd978195a82");
    private static final TestResource USER_HOLDER_OF_ROLE_BEING_ENABLED = new TestResource(TEST_RESOURCE_DIR, "user-holder-of-role-being-enabled.xml", "c6f7ddbe-a596-4a53-8acf-e03282f3da33");
    private static final TestResource USER_APPROVER_OF_ROLE_BEING_ENABLED_AND_DISABLED = new TestResource(TEST_RESOURCE_DIR, "user-approver-of-role-being-enabled-and-disabled.xml", "39764050-fbd8-4746-a8a6-cb9141ae31ae");

    private static final TestResource ROLE_BEING_DISABLED = new TestResource(TEST_RESOURCE_DIR, "role-being-disabled.xml", "4835efdc-6fee-438b-bb09-fd428a200dbb");
    private static final TestResource USER_HOLDER_OF_ROLE_BEING_DISABLED = new TestResource(TEST_RESOURCE_DIR, "user-holder-of-role-being-disabled.xml", "586fc857-71d8-4906-a61d-46ba7941be00");

    private static final TestResource ROLE_BEING_DISABLED_WITH_APPROVAL = new TestResource(TEST_RESOURCE_DIR, "role-being-disabled-with-approval.xml", "04c8d15f-da0a-4553-9b43-af835a7c8b82");
    private static final TestResource USER_HOLDER_OF_ROLE_BEING_DISABLED_WITH_APPROVAL = new TestResource(TEST_RESOURCE_DIR, "user-holder-of-role-being-disabled-with-approval.xml", "411258e6-191b-4957-95d3-86b6e25024d3");
    ...
    public void test830EnableAssignment() throws Exception {
        final String TEST_NAME = "test830EnableAssignment";
        TestUtil.displayTestTitle(this, TEST_NAME);
        login(userAdministrator);
        Task task = createTask(TEST_NAME);
        OperationResult result = task.getResult();
    ...
    public void test840DisableAssignment() throws Exception {
        final String TEST_NAME = "test840DisableAssignment";
        TestUtil.displayTestTitle(this, TEST_NAME);
        login(userAdministrator);
        Task task = createTask(TEST_NAME);
        OperationResult result = task.getResult();
    ...
    public void test850DisableAssignmentWithApproval() throws Exception {
        final String TEST_NAME = "test850DisableAssignmentWithApproval";
        TestUtil.displayTestTitle(this, TEST_NAME);
        login(userAdministrator);
        Task task = createTask(TEST_NAME);
        OperationResult result = task.getResult();
        ...
        assertEquals("wrong work items count", 1, approvalCase.getWorkItem().size());
        ...
        // WHEN
        displayWhen(TEST_NAME, "approving the operation");
        approveWorkItem(approvalCase.getWorkItem().get(0), task, result);

        // THEN
        displayThen(TEST_NAME, "approving the operation");
