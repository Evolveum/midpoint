...
public class AccessCertificationCampaignReiterationTriggerHandler implements TriggerHandler {
	...
	static final String HANDLER_URI = AccessCertificationConstants.NS_CERTIFICATION_TRIGGER_PREFIX + "/reiterate-campaign/handler-" + SchemaConstants.SCHEMA_MAJOR_VERSION;
