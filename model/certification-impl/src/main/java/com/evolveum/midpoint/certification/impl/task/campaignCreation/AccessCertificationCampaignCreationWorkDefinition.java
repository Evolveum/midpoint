 ...
 */
public class AccessCertificationCampaignCreationWorkDefinition extends AbstractWorkDefinition {

    private final @NotNull ObjectReferenceType campaignDefRef;

    AccessCertificationCampaignCreationWorkDefinition(@NotNull WorkDefinitionFactory.@NotNull WorkDefinitionInfo info) throws ConfigurationException {
        super(info);
