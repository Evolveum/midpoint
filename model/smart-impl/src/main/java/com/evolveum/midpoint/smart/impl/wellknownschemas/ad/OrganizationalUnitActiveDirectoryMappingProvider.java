...
@Component
public class OrganizationalUnitActiveDirectoryMappingProvider implements WellKnownSchemaProvider {

    private static final Trace LOGGER = TraceManager.getTrace(OrganizationalUnitActiveDirectoryMappingProvider.class);

    @Override
    public WellKnownSchemaType getSupportedSchemaType() {
        return WellKnownSchemaType.AD_ORGANIZATIONAL_UNIT;
    }
