 ...
 */
@Component
public class UncachedCorrelationObjectsSampler implements ObjectsSampler<List<PrismObject<ShadowType>>> {

    private static final Trace LOGGER = TraceManager.getTrace(UncachedCorrelationObjectsSampler.class);

    private static final int SAMPLE_SIZE = 2000;

    private final ModelService modelService;

    public UncachedCorrelationObjectsSampler(ModelService modelService) {
    ...
    public List<PrismObject<ShadowType>> sample(
        ...
        LOGGER.debug("Sampling shadows for correlation (uncached): {}/{}, sampleSize={}",
