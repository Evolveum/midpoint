 ...
 */
@Component
public class UncachedMappingObjectsSampler implements ObjectsSampler<MappingSampleResult> {

    private static final Trace LOGGER = TraceManager.getTrace(UncachedMappingObjectsSampler.class);
    ...
    public UncachedMappingObjectsSampler(ModelService modelService) {
    ...
    public MappingSampleResult sample(
        ...
        LOGGER.debug("Sampling shadows for mappings (uncached): {}/{}, llmSize={}, validationSize={}",
