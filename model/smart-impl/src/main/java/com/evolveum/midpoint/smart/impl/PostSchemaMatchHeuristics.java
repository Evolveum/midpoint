...
class PostSchemaMatchHeuristics {
    ...
    /**
     * Shadow attributes with fewer than this fraction of objects having a non-missing value
     * are excluded from name mapping candidates.
     */
    ...
    private double computeUniquenessRatio(ShadowAttributeStatisticsType attrStats, int totalObjects) {
        ...
        if ((double) presentCount / totalObjects < PRESENCE_THRESHOLD) {
            return 0.0;
        }
