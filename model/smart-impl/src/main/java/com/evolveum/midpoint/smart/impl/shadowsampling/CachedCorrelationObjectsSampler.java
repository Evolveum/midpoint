 ...
 */
@Component
public class CachedCorrelationObjectsSampler implements ObjectsSampler<List<PrismObject<ShadowType>>> {

    private static final Trace LOGGER = TraceManager.getTrace(CachedCorrelationObjectsSampler.class);

    private static final int SAMPLE_SIZE = 5000;

    private final ModelService modelService;

    public CachedCorrelationObjectsSampler(ModelService modelService) {
    ...
    public List<PrismObject<ShadowType>> sample(
        ...
        LOGGER.debug("Sampling shadows for correlation (cached): {}/{}, sampleSize={}",
