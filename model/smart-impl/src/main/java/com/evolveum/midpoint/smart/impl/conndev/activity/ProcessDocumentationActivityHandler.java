...
public class ProcessDocumentationActivityHandler
        extends ModelActivityHandler<ProcessDocumentationActivityHandler.WorkDefinition, ProcessDocumentationActivityHandler> {
    ...
    public void unregister() {
        handlerRegistry.unregister(
                ConnDevProcessDocumentationWorkDefinitionType.COMPLEX_TYPE, ProcessDocumentationActivityHandler.WorkDefinition.class);
    }
