...
public class MappingsStatisticsComputationActivityRun extends SearchBasedActivityRun<
    ...
    public MappingsStatisticsComputationActivityRun(@NotNull ActivityRunInstantiationContext<ObjectTypeRelatedSuggestionWorkDefinition, MappingsSuggestionActivityHandler> context, @NotNull String shortNameCapitalized) {
