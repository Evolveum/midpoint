...
public class TestSmartIntegrationServiceImpl extends AbstractSmartIntegrationTest {
    ...
    public void test120SuggestObjectTypesWithErrorInFilter() throws CommonException {
        ...
        then("there is at least one suggestion with empty filter");
        assertSuccess(result);
        assertThat(objectTypes).isNotNull();
        assertThat(objectTypes.getObjectType()).isNotEmpty();
        assertThat(objectTypes.getObjectType().get(0).getDelineation().getFilter()).isEmpty();
...
//                .satisfies(p -> focusItemName.equivalent(p));
    ...
    // =============================
    // Tests for predefined reactions
    // =============================
    ...
    public void test500PredefinedReactionsForSource() {
        var reactions = smartIntegrationService.getPredefinedSynchronizationReactions(
                DirectionScenario.SOURCE, true); // flag irrelevant for SOURCE
    ...
    public void test520PredefinedReactionsForTargetWithoutCorrelationCase() {
        var reactions = smartIntegrationService.getPredefinedSynchronizationReactions(
                DirectionScenario.TARGET_WITH_FEEDBACK, false);
