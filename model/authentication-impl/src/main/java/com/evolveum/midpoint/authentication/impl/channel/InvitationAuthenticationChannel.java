...
public class InvitationAuthenticationChannel extends AuthenticationChannelImpl {
    ...
    public Collection<Authorization> resolveAuthorities(Collection<Authorization> authorities) {
        ...
        authorizationType.getAction().add(AuthorizationConstants.AUTZ_UI_INVITATION_URL);
        Authorization invitationAuth = new Authorization(authorizationType);
        newAuthorities.add(invitationAuth);
