...
import com.evolveum.midpoint.authentication.impl.security.module.SamlModuleWebSecurityConfig;
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
        ...
        if (authentication instanceof MidpointAuthentication) {
            ...
            if (moduleAuthentication instanceof Saml2ModuleAuthenticationImpl) {
                providers = ((Saml2ModuleAuthenticationImpl) moduleAuthentication).getProviders();
