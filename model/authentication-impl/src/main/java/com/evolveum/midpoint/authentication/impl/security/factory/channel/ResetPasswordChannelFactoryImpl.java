...
import com.evolveum.midpoint.authentication.impl.security.channel.ResetPasswordAuthenticationChannel;
 ...
 */
@Component
public class ResetPasswordChannelFactoryImpl extends AbstractChannelFactory {
    @Override
