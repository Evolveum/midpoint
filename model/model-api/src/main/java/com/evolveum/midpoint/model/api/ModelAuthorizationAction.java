...
public enum ModelAuthorizationAction implements DisplayableValue<String> {
    ...
    /**
     * Allows the object to be modified. When asked about it (e.g., via {@link SecurityEnforcer#isAuthorized(
     * String, AuthorizationPhaseType, AuthorizationParameters, OwnerResolver, Task, OperationResult)}),
