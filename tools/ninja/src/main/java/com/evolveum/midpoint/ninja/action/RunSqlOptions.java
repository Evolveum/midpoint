...
public class RunSqlOptions {
    ...
    @Parameter(names = { P_AUDIT_SCRIPTS_LONG }, descriptionKey = "runSql.auditScripts", variableArity = true)
    private List<File> auditScripts = new ArrayList<>();

    @Parameter(names = { P_NO_AUDIT_LONG }, descriptionKey = "runSql.noAudit")
    private boolean noAudit;

    @Parameter(names = { P_NO_REPOSITORY_LONG }, descriptionKey = "runSql.noRepository")
    private boolean noRepository;
    ...
    public void setNoRepository(boolean noRepository) {
