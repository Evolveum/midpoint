...
public class TestConnectionModal<T> extends ModalBox<T> {
    ...
    public boolean isTestSuccess() {
        ...
        $(Schrodinger.byDataId("div", "messagesPanel")).waitUntil(Condition.appears, MidPoint.TIMEOUT_EXTRA_LONG_1_M);
...
//                && feedbackResourceSchema().isSuccess();
        ...
        for (SelenideElement element : detailBoxes) {
            ...
            element.waitUntil(Condition.appears, MidPoint.TIMEOUT_EXTRA_LONG_1_M);
