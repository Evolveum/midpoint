...
public class TestGrouperLargeGroupImport extends AbstractGrouperTest {
    ...
    private static final TestResource TASK_IMPORT_GROUPS = new TestResource(TEST_DIR, "task-import-groups.xml", "e2edaa90-7624-4a82-8a7c-92e00c78d8d3");
    ...
    public void initSystem(Task initTask, OperationResult initResult) throws Exception {
        ...
        createGroup(ALUMNI_NAME, ALUMNI_USERS);
        createGroup(STAFF_NAME, STAFF_USERS);
