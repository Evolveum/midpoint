...
//    }
    ...
    public void test200assignOpenDJBob() throws Exception {
        displayTestTitle(getTestNameShort());
    ...
    public void test220previewRecomputeBob() throws Exception {
        ...
        ModelContext<UserType> previewContext = previewChanges(prismContext.deltaFor(UserType.class).asObjectDelta(userBobOid), ModelExecuteOptions.createReconcile(), task, result);
