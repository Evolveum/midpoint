 ...
 * REQUIREMENTS:
 *
 * 1) The COmanage Match runs as an external system. See `resource-sis.xml` for URL and credentials.
 ...
 */
public class TestIdMatchCorrelationSimpleReal extends AbstractSimpleIdMatchCorrelationTest {
