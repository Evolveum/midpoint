...
public class DummyAdScenario extends AbstractDummyScenario {
    ...
    private DummyAdScenario(@NotNull DummyResourceContoller controller) {
        super(controller);
    }

    public static DummyAdScenario on(DummyResourceContoller controller) {
        return new DummyAdScenario(controller);
    }

    public DummyAdScenario initialize() {
        account.initialize();
        group.initialize();
