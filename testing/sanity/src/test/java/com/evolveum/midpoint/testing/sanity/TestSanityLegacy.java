...
public class TestSanityLegacy extends AbstractModelIntegrationTest {
    ...
    private static final Trace LOGGER = TraceManager.getTrace(TestSanityLegacy.class);
    ...
    public void test001SelfTests() throws Exception {
        ...
        // GIVEN
        Task task = taskManager.createTaskInstance(TestSanityLegacy.class.getName()+"."+TEST_NAME);
    ...
    private void checkRepoOpenDjResource() throws ObjectNotFoundException, SchemaException {
    	OperationResult result = new OperationResult(TestSanityLegacy.class.getName()+".checkRepoOpenDjResource");
...
//        assertSuccess("modifyObject has failed", result);
    ...
    public void test300LiveSyncInit() throws Exception {
        ...
        final OperationResult result = new OperationResult(TestSanityLegacy.class.getName()
                + "." + TEST_NAME);
...
//        assertEquals("Name doesn't match", "uid=" + userName + ",ou=People,dc=example,dc=com", account.getName());
    ...
    public void test400ImportFromResource() throws Exception {
        ...
        OperationResult result = new OperationResult(TestSanityLegacy.class.getName()
                + "." + TEST_NAME);
...
//        ObjectQuery query = ObjectQuery.createObjectQuery(EqualsFilter.createEqual(UserType.class, prismContext, UserType.F_NAME, ELAINE_NAME));
    ...
    public void test485ListResourcesWithBrokenResource() throws Exception {
        ...
        // GIVEN
        Task task = taskManager.createTaskInstance(TestSanityLegacy.class.getName() + ".test410ListResourcesWithBrokenResource");
