...
See the link:https://github.com/Evolveum/midpoint/blob/support-4.8/repo/system-init/src/main/resources/initial-objects/value-policy/010-value-policy.xml[default password policy definition in the midPoint source code repository].
