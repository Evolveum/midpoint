...
The rest of the functionality is considered to be link:/midpoint/versioning/experimental.adoc[experimental].
...
REST support for flexible authentication is link:/midpoint/versioning/experimental.adoc[experimental].
