...
Basic idea of flexible authentication is described on link:..[Flexible Authentication] page.
...
Flexible authentication is configured in link:/midpoint/reference/security/security-policy[Security Policy], which is used as global security policy in System Configuration.
...
The rest of the functionality is considered to be link:/midpoint/versioning/experimental/[experimental].
...
Please see link:/midpoint/features/planned/flexible-authentication/[Flexible Authentication Improvements] for the details.


== See Also

* link:..[Flexible Authentication]

* link:/midpoint/reference/security/security-policy[Security Policy Configuration]
