...
| xref:/security/authentication/flexible-authentication/modules/loginForm.adoc[loginForm]
| LoginForm module is used for interactive log-in of a user by using HTML forms.

| xref:/security/authentication/flexible-authentication/modules/httpBasic.adoc[httpBasic]
| Definition of HTTP BASIC authentication module (RFC 7617).

| xref:/security/authentication/flexible-authentication/modules/httpSecQ.adoc[httpSecQ]
...
| xref:/security/authentication/flexible-authentication/modules/archetypeSelection.adoc[archetypeSelection]
...
| xref:/security/authentication/flexible-authentication/modules/correlation.adoc[correlation]
...
| xref:/security/authentication/flexible-authentication/modules/ldap.adoc[ldap]
| LDAP authentication module supports authentication via LDAP server.

| xref:/security/authentication/flexible-authentication/modules/httpHeader.adoc[httpHeader]
| Pseudo-authentication for pre-authenticated users. Based on HTTP header values.

| xref:/security/authentication/flexible-authentication/modules/saml2.adoc[saml2]
| SAML2 authentication module supports authentication via Identity provider with SAML2.

| xref:/security/authentication/flexible-authentication/modules/oidc.adoc[oidc]
...
| xref:/security/authentication/flexible-authentication/modules/duo.adoc[duo]
