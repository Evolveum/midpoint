...
This change need to be reflected to the interfaces as well (wiki:IDM+Model+Interface[IDM Model Interface], xref:/midpoint/reference/interfaces/rest/[REST API]). There needs to be several new methods:
