...
| N/A
| N/A
| Allows to execute xref:/midpoint/reference/misc/bulk/[midPoint scripts a.k.a. actions]
| Authorizes the possibility to execute the actions.
See xref:bulk-actions.adoc[].

| http://midpoint.evolveum.com/xml/ns/public/security/authorization-model-3#runReport
| N/A
| N/A
| Allows to execute run report action.
| Authorizes the possibility to run reports.
|===
