...
| 'Create report' component authorization on the object list pages (e.g. 'Create report' toolbar button on the All Users page).
...
Please see xref:/midpoint/reference/certification/authorization/[Access Certification Security] for detailed list.
