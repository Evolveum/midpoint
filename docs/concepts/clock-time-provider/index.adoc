...
* link:https://evolveum.com/downloads/midpoint/4.9/midpoint-4.9-javadoc/com/evolveum/midpoint/common/Clock.html[Javadoc for the Clock class]
* link:https://github.com/Evolveum/midpoint/blob/support-4.9/infra/common/src/main/java/com/evolveum/midpoint/common/Clock.java[Clock.java source]
