...
* link:https://evolveum.com/downloads/midpoint/4.8/midpoint-4.8-javadoc/com/evolveum/midpoint/common/Clock.html[Javadoc for the Clock class]
* link:https://github.com/Evolveum/midpoint/blob/support-4.8/infra/common/src/main/java/com/evolveum/midpoint/common/Clock.java[Clock.java source]
...
* If you use `Clock` to travel back in time, xref:/midpoint/reference/tasks/activities/error-handling/#_triggers[trigger] and xref:/midpoint/reference/tasks/specific/focus-validity-scan/[validity] scanners may behave unexpectedly regarding the objects they choose to process.
