...
To see how you can add marks to individual shadows manually in the midPoint GUI, refer to xref:/midpoint/reference/admin-gui/resource-wizard/object-type/policies/#markManually[Object type policies].
