...
Individual shadows can be marked using GUI when xref:/midpoint/reference/master/concepts/mark/manual-marking/#marking-shadows-in-resource-details[browsing resource shadows of specific resources] or in xref:/midpoint/reference/master/concepts/mark/manual-marking/#marking-shadows-in-simulation-results-details[simulation results].
