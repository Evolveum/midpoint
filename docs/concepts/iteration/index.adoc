...
Iteration mechanism can be easily enabled and customized in xref:/midpoint/reference/expressions/object-template/[Object Template] and wiki:Outbound+Mapping[Outbound Mapping].
