...
:page-wiki-metadata-modify-user: atdhe.musliu
:page-wiki-metadata-modify-date: 2023-05-22T11:51:55.968+02:00
        ...
        <code>
            ...
            if (administrativeStatus == ActivationStatusType.DISABLED) {
                ...
                for (AssignmentType assign : user.getAssignment()) {
                    assignmentDelta = prismContext.deltaFactory().container().createModificationDelete(UserType.F_ASSIGNMENT, UserType.class, assign.clone());
