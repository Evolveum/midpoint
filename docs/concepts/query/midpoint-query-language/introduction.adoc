...
| dateTime
| `@metadata/storage/createTimestamp >= "2024-03-01"`
| DateTime values are enclosed in quotes (') or double quotes ("). It can be compared as dates or date and time - written in format https://en.wikipedia.org/wiki/ISO_8601[ISO-8601].

|
| `@metadata/storage/createTimestamp >= "2024-03-01T15:30:00"`
