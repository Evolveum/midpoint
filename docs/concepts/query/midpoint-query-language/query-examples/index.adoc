...
|Dereferencing (search with @) is working in the assignment panel only when xref:/midpoint/quides/assignment-repository-search/index.adoc[repository search is enabled].
|===
