...
| linkRef | Projections | c:ObjectReferenceType | xref:#_projectionholdertype[ProjectionHolderType] |
...
[#_projectionholdertype]
=== ProjectionHolderType

Common parent of the xref:#_focustype[FocusType] and the xref:#_casetype[CaseType].
In addition to the items inherited from the xref:#_assignmentholdertype[AssignmentHolderType], it defines the `linkRef` item (projections).
...
| tenantRef | Tenant | c:ObjectReferenceType | xref:#_assignmentholdertype[AssignmentHolderType]/ xref:#_objecttype[ObjectType] |
| threadStopAction |  | tns:ThreadStopActionType |  |
| trigger |  | xref:#_triggertype[tns:TriggerType] | xref:#_assignmentholdertype[AssignmentHolderType]/ xref:#_objecttype[ObjectType] |
| waitingReason |  | tns:TaskWaitingReasonType |  |
|===
