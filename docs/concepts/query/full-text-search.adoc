...
. When updating these objects, midPoint extracts content of these properties, normalizes it, and stores in a separate `m_object.fullTextInfo` column.
...
Full text data can be queried by running following SQL:
