...
[IMPORTANT]
====
* Reference query is supported since version 4.7.
...
** All the `ref` filters must use "self" path - which is an empty path in the XML representation
or `.` in Axiom query language.
