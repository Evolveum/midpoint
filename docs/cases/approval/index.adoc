...
* When that operation is evaluated, wiki:Clockwork+and+Projector[internal algorithms] in midPoint will analyze xref:/midpoint/reference/roles-policies/policy-rules/[policy rules] that are applicable to the new role.
