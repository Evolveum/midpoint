...
MidPoint will evaluate xref:/midpoint/reference/roles-policies/rbac/[role hierarchies], wiki:Roles,+Metaroles+and+Generic+Synchronization[metaroles], gather all the applicable wiki:Policy+Rules[policy rules] and apply default policies.
