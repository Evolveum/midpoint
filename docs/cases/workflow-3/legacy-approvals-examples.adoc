...
Expression can be of any supported type, be it wiki:Script+Expression[script expression] or xref:/midpoint/reference/expressions/expressions/[any other expression type].
