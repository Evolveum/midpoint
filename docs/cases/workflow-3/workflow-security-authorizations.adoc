...
. Q: Although the structure of certifications is a bit similar to the one of case management (case  work items), in GUI they have a different terminology - see wiki:Access+Certification+Security[Access Certification Security]:
