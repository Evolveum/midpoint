...
[source]
----
%outline custom containing 'Product information : http://wiki.evolveum.com/display/midPoint' 10 '=========> System startup at ${date} <========='
...
For installation instructions, please see wiki:Eclipse+plugin+installation+HOWTO[Eclipse plugin installation HOWTO].
