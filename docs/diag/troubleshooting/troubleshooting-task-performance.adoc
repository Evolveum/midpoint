...
You can configure xref:/midpoint/reference/support-4.8/tasks/activities/reporting/execution-reports/[task execution report] in order to monitor selected performance indicators of the task.
