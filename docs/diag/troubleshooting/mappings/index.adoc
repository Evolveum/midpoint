...
Therefore almost all Projector components work with xref:/midpoint/devel/prism/concepts/deltas/[deltas] and wiki:Triple[triples]. The basic process is like this:
