...
For MEL expressions, see xref:/midpoint/reference/expressions/expressions/script/mel/specification/[MEL Specification].
For Groovy see xref:/midpoint/reference/expressions/expressions/script/functions/[Script Expression Functions] page for more details.
...
See xref:/midpoint/reference/expressions/expressions/script/mel/migration/[Troubleshooting MEL Expressions] guide for a list of common errors, their explanation and remediation tips.
...
* xref:/midpoint/reference/expressions/expressions/script/mel/migration/[Troubleshooting MEL Expressions]
