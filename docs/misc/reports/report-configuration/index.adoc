...
Support for wiki:multivalue[multi-value parameters] exists since 3.6. If you check 'For prompting' attribute, it means that this parameter is shown in the pop-up panel when you run report.
...
These properties are then used for customization of run popup such as wiki:lookup[lookup tables].
+
