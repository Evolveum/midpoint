...
Reports and data tables can also be exported to XLSX.
In XLSX output all values are written as text cells, which spreadsheet applications do not interpret as formulas.
Where the spreadsheet is the intended consumer, prefer XLSX over CSV.
