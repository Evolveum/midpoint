...
columns:
  - heading: JavaDoc
    linkUrlPattern: "https://download.evolveum.com/midpoint/${download-tag}/midpoint-${maven-version}-javadoc/com/evolveum/midpoint/notifications/api/events/WorkflowProcessEvent.html"
    linkText: "JavaDoc"
%}
++++
