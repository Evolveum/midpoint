...
Mention loggers NOTIFICATION and TRANSPORT (LoggingComponentType) and DEBUG level for them,
when you don't know what is happening, why something is missing, notification is not sent, etc.
