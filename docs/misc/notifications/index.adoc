...
For instructions how to configure notifiers, filters, and transports please see xref:/midpoint/reference/misc/notifications/configuration/[administrator's guide].
...
* xref:/midpoint/reference/misc/notifications/configuration/[Configuring notifications]
