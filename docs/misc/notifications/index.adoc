...
. *Resource object notifications.*
These are related to the objects on resources, e.g. creation, modification, or removal of accounts, groups, etc.
...
////
TODO document expression variables
