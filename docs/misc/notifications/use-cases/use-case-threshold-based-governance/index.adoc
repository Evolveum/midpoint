...
. Create a xref:/midpoint/reference/roles-policies/roles/[role]
    with a xref:/midpoint/reference/roles-policies/policies/policy-rules/[policy rule]
    defining xref:/midpoint/reference/roles-policies/policies/policy-rule-constraints-examples/[constraint]
...
See also xref:/midpoint/reference/roles-policies/roles/assignment/assignment-vs-inducement/[]
