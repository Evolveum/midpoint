...
There is a special object type for lookup tables (wiki:LookupTableType[LookupTableType]). The entire table can be represented as midPoint object and imported into the midPoint repository:
