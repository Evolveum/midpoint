...
Note that each action has "legacy name", under which it can be called in the traditional (dynamic way).
...
[%autowidth]
|===
| Action (legacy name) | Modern name | Description | Parameter | Kind | Description
