...
xref:/midpoint/reference/cases/workflow-3/[Workflows (midPoint 3.x)] and xref:/midpoint/reference/roles-policies/certification/[access certification] fully support the concept of deputy.
