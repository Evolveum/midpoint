= Object Collection Type Web Resource
:page-nav-title: REST API Object Collection Resource
...
The Object Collection web resource is a part of the Create-Read-Update-Delete (CRUD) web resources
