...
8. If you want information regarding the users case, you will have to query the open cases. A REST location header or redirect is currently missing, please see link:https://support.evolveum.com/wp/9493[work package]
