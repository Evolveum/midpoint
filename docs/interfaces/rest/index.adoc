...
1. xref:/midpoint/reference/interfaces/rest/operations/examples/search-objects-filter/[List all users with their profile information.]
2. xref:/midpoint/reference/interfaces/rest/operations/examples/get-user-unique-id/[Get User with the REST API]
3. xref:/midpoint/reference/interfaces/rest/operations/examples/create-user/[Create User with the REST API]
