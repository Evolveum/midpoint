...
We have a support for xref:/midpoint/devel/prism/[data structures] that are wiki:Repository+Subsystem[independent of actual database structure]. We have support for namespaces which reduces the risk of conflicting extensions and new midPoint features.
