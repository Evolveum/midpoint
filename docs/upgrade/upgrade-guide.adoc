...
This document describes the necessary steps to upgrade xref:/midpoint/get-started/install/bare-installation/distribution/[MidPoint installation].
...
For more information see xref:/midpoint/reference/upgrade/upgrade-with-ninja/[].
