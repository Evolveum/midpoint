...
The ability of a login role to "hold" the account in a disabled state can be done in a much easier way by using wiki:Resource+Schema+Handling:+Activation[activation existence mapping].
