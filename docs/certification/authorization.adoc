...
doc-type: config
---
= Access certification authorizations
...
:page-description: This page explains how access to certification features in midPoint is controlled through specific authorizations.
:page-keywords: certification authorization, action URI, model level actions, GUI actions
:page-toc: top
:experimental:

This page explains how access to certification features in midPoint is controlled through specific authorizations.
