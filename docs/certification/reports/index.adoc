...
:page-description: This article shows examples of access certification reports in midPoint and helps you understand how to use them effectively in compliance and governance workflows.
...
This article shows examples of the available access certification reports in midPoint and helps you understand how to use them effectively in compliance and governance workflows.
...
Depending on the xref:/midpoint/reference/certification/determining-case-outcome/[review strategy], some cases might be "stopped": they do not advance to the next stage after being e.g. revoked in a previous stage.
