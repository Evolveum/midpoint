...
:page-description: A quick access certification tutorial: how to configure a certification campaign definition, create and start a campaign, and review its results.
...
+
If needed, you can extend the responses with the following options (learn more about decision menu items configuration, as well as about other possible menu item actions in xref:/midpoint/reference/certification/certification-campaign-configuration/gui-configuration/actions/[GUI Action Configuration]):
