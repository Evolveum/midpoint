...
:page-moved-from: /midpoint/reference/roles-policies/certification/stages/, /midpoint/reference/roles-policies/policies/certification/stages/
:page-description: This article describes how to configure individual stages within an access certification campaign. It covers the reviewer selection, deadlines, notification behavior, and timed escalation within each stage.
...
This article describes how to configure individual stages within an access certification campaign.
...
See xref:/midpoint/reference/certification/determining-case-outcome.adoc#stage-level[stage level strategies] for details.
...
For more details, see xref:/midpoint/reference/certification/determining-case-outcome/[].
...
For more information, see xref:/midpoint/reference/certification/notifications/[].
