...
:page-description: This article shows an example of a certification dashboard widget to be displayed on the self-service dashboard page.
:page-keywords: certification campaign, GUI, dashboard, widget

You can configure a certification dashboard widget to be displayed on the self-service dashboard page.
The widget configuration is done as a part of the xref:/midpoint/reference/concepts/system-configuration-object/[system configuration initial object].
