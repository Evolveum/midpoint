...
:page-moved-from: /midpoint/reference/roles-policies/policies/certification/columns-configuration/, /midpoint/reference/roles-policies/certification/columns-configuration/
:page-nav-title: Columns configuration
:page-upkeep-status: yellow
:page-display-order: 10
:page-description: This article shows how you can configure columns in GUI for your certification items collection view.
:page-keywords: columns configuration, predefined columns, accessCertification, certification
:page-toc: top

This article shows how you can configure columns in GUI for your certification items collection view.
...
This article shows you how to customize the predefined columns configuration.
...
// verified as valid on 2026-08-24 (it is actually more "frozen" rather then experimental
