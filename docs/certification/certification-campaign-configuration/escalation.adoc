...
:page-nav-title: Escalation
:page-display-order: 60
:page-upkeep-status: yellow
:page-description: This article describes what escalations are, how to use them in campaigns to enforce accountability, ensure higher scrutiny for risky items, and prevent stalled certifications.
:page-keywords: escalation, certification campaign, escalate, timed action
:page-toc: top
:page-moved-from: /midpoint/reference/roles-policies/certification/escalation/, /midpoint/reference/roles-policies/policies/certification/escalation/

This article describes what escalations are, how to use them in campaigns to enforce accountability, ensure higher scrutiny for risky items, and prevent stalled certifications.

== What is an access certification campaign escalation

Access certification campaign escalation is a mechanism that automatically reassigns a case or notifies additional users when the reviewer of the case has not acted on their assigned certification items within the defined time frame.
