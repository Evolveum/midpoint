...
:page-description: This section contains description, configuration reference, and migration and maintenance guides of the native PostgreSQL repository for midPoint.
:page-keywords: postgresql, native repository, database, repository
