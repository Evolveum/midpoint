= Using Native PostgreSQL Repository in versions 4.4 to 4.7
:page-toc: top
:page-display-order: 6
:page-nav-title: Usage before 4.8
:page-since: "4.4"

NOTE: For version 4.8 and newer see xref:/midpoint/reference/repository/native-postgresql/usage/[Using Native PostgreSQL Repository]
