...
| `ownerOid`
| xref:#m_lookup_table[`m_lookup_table.oid`]
| ON DELETE CASCADE
...
| xref:#m_connector_development[`m_connector_development`]
...
| xref:#m_connector_host[`m_connector_host`]
| xref:infrastructure.adoc#routine_delete_object_oid[`delete_object_oid`]
...
| xref:#m_lookup_table[`m_lookup_table`]
| xref:infrastructure.adoc#routine_delete_object_oid[`delete_object_oid`]
