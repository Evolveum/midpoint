...
| `BYTEA`
| 
| Serialized full object representation, however some items are stored separately. See https://docs.evolveum.com/midpoint/reference/master/repository/native-postgresql/splitted-fullobject/[splitted-fullobject] for more information.
