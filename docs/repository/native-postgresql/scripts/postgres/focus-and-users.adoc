...
No primary key is defined directly on this table. The table inherits from xref:infrastructure.adoc#m_assignment_holder[`m_assignment_holder`].
...
| xref:#m_generic_object[`m_generic_object`]
