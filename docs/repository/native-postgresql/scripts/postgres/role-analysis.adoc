...
| xref:#m_role_analysis_cluster[`m_role_analysis_cluster`]
...
| xref:#m_role_analysis_outlier[`m_role_analysis_outlier`]
| xref:infrastructure.adoc#routine_delete_object_oid[`delete_object_oid`]
...
| xref:#m_role_analysis_session[`m_role_analysis_session`]
| xref:infrastructure.adoc#routine_delete_object_oid[`delete_object_oid`]
