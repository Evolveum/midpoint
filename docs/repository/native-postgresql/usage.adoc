---
midpoint-feature: identity-repository-postgresql
doc-type: guide
---
...
. Get the midPoint distribution and install it as described xref:/midpoint/get-started/install/bare-installation/distribution/[here];
...
. Finally, you can run midPoint; this is described in the rest of the xref:/midpoint/get-started/install/bare-installation/distribution/[installation document] mentioned in the first step.
...
More details on running midPoint are mentioned in the xref:/midpoint/get-started/install/bare-installation/distribution/[installation document].
