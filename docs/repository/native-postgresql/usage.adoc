...
NOTE: For version 4.4 to 4.7  see xref:/midpoint/reference/repository/native-postgresql/usage-before-4.8/[Using Native PostgreSQL Repository in versions 4.4 to 4.7]
