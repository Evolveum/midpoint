...
* Check the link:/midpoint/reference/deployment/clustering-ha/[Clustering / high availability setup]
documentation for how to set up multiple midPoint nodes.

* Tips about configuring the database can be found xref:../native-postgresql/postgresql-configuration/[here].
...
* link:/midpoint/reference/deployment/clustering-ha/[Clustering / high availability setup]
