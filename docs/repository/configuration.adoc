...
:page-toc: top
:page-since: "4.4"
:page-description: This article is a configuration reference for the midPoint native PostgreSQL repository.
:page-keywords: repository, database, repository configuration, native repository, postgresql

This article is a configuration reference for the midPoint native PostgreSQL repository.
For old generic repository configuration see xref:/midpoint/reference/repository/generic/configuration/[].
