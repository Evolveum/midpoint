...
:page-description: This section describes the deprecated generic repository for midPoint.
:page-keywords: repository, database, sql, generic repository

This section describes the deprecated generic repository for midPoint.
