...
New Native repository uses different upgrade described xref:../native-postgresql/usage/[here].
====
...
Please see a discussion for this in xref:/release/4.1/[4.1 release notes] and link:https://github.com/Evolveum/midpoint/commit/a4672da3ce410a20d5196c6675970d5689ddb25c[this commit].
