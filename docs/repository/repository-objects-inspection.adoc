...
:page-description: This guide shows how to inspect repository objects to resolve performance issues.
:page-keywords: repository, database, performance, inspection, diagnose
