...
:page-since: "4.4"
:page-toc: top
:page-description: This article is a configuration reference for setting up the auditing functionality of midPoint.
:page-keywords: audit, audit log, sql audit, audit trail, audit repository
