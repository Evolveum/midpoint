...
* *xref:/midpoint/reference/roles-policies/roles/rbac/[Roles]* are used to define _provisioning_ and _access control_ schemes.
...
Roles can be xref:/midpoint/reference/roles-policies/roles/rbac/[very flexible and dynamic]. There can be hierarchical roles, conditional roles, parametric roles, etc.
...
Roles can be personalized for each particular user, e.g. by using xref:/midpoint/reference/roles-policies/roles/assignment/[assignment parameters].
...
And this may depend on the way how the role is xref:/midpoint/reference/roles-policies/roles/assignment/[assigned] to a particular user.
...
Simply speaking it can have xref:/midpoint/reference/roles-policies/roles/assignment/assignment-vs-inducement/[inducements]. This can be used for multitude of purposes, e.g. to "automatically assign" roles for members of particular organizational unit or project.
