...
If an account is assigned to the user the xref:/midpoint/reference/roles-policies/roles/assignment/[assignment] structure is added to the user object.
...
Note that the mechanism of xref:/midpoint/reference/roles-policies/roles/assignment/[assignments] is actually the same concept that is used to model xref:/midpoint/reference/roles-policies/roles/rbac/[roles]. Simply speaking roles can be seen as indirect assignments.
