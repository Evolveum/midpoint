...
:page-moved-from: /midpoint/reference/roles-policies/rbac/
...
MidPoint advanced RBAC mechanism, together with role auto-assignment capabilities and other policy mechanisms create a very powerful combination to express complex policies: xref:../pdrbac/[policy-driven RBAC].
...
See xref:/midpoint/reference/roles-policies/roles/roles-and-policies-configuration/[Roles and Policies Configuration] and xref:/midpoint/reference/synchronization/generic-synchronization/[Generic Synchronization] for more details.
...
* xref:/midpoint/reference/roles-policies/roles/roles-and-policies-configuration/[Roles and Policies Configuration] section in xref:/midpoint/[Documentation]
