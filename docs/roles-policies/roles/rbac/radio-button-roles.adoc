...
. xref:/midpoint/reference/roles-policies/policies/policy-rules/[Policy Rules] that implement (almost) ordinary xref:/midpoint/reference/roles-policies/policies/segregation-of-duties/[role exclusion].

. The "prune" policy action.

. Clever use of xref:/midpoint/reference/roles-policies/policies/metaroles/gensync/[metarole] to define the radio button class.
