...
:page-moved-from: /midpoint/reference/roles-policies/mining/anonymous-data-export/
...
Exporting anonymized role mining data using the Ninja tool is available. To perform the export, refer to the xrefv:/midpoint/reference/support-4.9/deployment/ninja/command/export-mining[Ninja documentation].
