...
:page-summary: This page describes the Segregation of Duties (SoD) mechanism in midPoint, which prevents accumulating too much power in the hands of a single person by placing constraints on assignments of entitlements to users.
