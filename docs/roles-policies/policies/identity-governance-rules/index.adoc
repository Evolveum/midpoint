...
Therefore, natural method of enforcing a policy rules is to place the rule inside an xref:/midpoint/reference/roles-policies/roles/assignment/assignment-vs-inducement/[inducement] in the _Application_ archetype.
