...
The basic idea is to express the policies in a form of xref:/midpoint/reference/roles-policies/policies/metaroles/policy/[metaroles]. For example the policy that drives role assignment through an approval will be expressed in "approval by manager" metarole.
This metarole will contain all the xref:/midpoint/reference/roles-policies/policies/policy-rules/[policy rules] necessary to express the approval policy.
...
And that is what we call xref:/midpoint/reference/roles-policies/policies/metaroles/gensync/[metarole]. The situation looks like this:
...
But those rules are specified inside xref:/midpoint/reference/roles-policies/roles/assignment/assignment-vs-inducement/[inducement]. Therefore the policy rules do not apply to the role which contains them, i.e. the rules do not apply to the "Approval by manager metarole".
...
Please see xref:/midpoint/reference/roles-policies/policies/applicable-policies/configuration/[Applicable Policy Configuration] page for configuration details and examples.
