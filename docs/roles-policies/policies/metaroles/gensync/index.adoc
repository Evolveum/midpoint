...
Therefore they are not considered a part of the normal order when evaluating meta-roles.
...
Index 0 is the focal object, index 1 is the first (plain) role, index 2 is a meta-role, index 3 is a meta-meta-role, and so on.
