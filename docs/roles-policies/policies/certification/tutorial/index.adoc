...
:page-description: A quick access certification tutorial: how to configure a certification campaign definition, create and start a campaign, and how to review its results.
:page-keywords: certification campaign, access campaign, campaign definition, review campaign
:experimental:
