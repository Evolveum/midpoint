...
To better illustrate meaning of various wiki:Assignment+Configuration#AssignmentConfiguration-ConstructionVariables[ assignment-related variables] let us present an example.
