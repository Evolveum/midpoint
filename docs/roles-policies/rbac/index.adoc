...
:page-moved-from: /midpoint/reference/roles-policies/roles/rbac/
...
.Partially supported
====
Parametric roles are fully supported by midPoint core (the "engine" or "IDM Model").
But user interface support for parametric roles is still missing.
