...
If you really want to assign just this one resource then use xref:/midpoint/reference/roles-policies/assignment/configuration/[direct construction assignment] and wiki:Outbound+Mapping[outbound mappings]. If you want to create a role create something more generic such as "Basic Role" or "Employee".
