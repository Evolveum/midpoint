...
Repetition is daily bread in almost all IDM deployments.
...
That's what metarole can do.

Metaroles usually take form of xref:/midpoint/reference/schema/policy[policy objets], e.g. as xref:/midpoint/reference/support-4.8/roles-policies/classification/[classifications].
