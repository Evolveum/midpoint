...
There are special kinds of assignment that is used to define wiki:Deputy[Deputy]. This assignment has xref:/midpoint/reference/concepts/relation/[Relation] set to `deputy`. This is a special case used to delegate the privileges.
