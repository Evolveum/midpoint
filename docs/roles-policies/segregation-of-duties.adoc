...
However this configuration can easily be created an maintained by using xref:/midpoint/reference/roles-policies/rbac/[role hierarchies] and wiki:Roles,+Metaroles+and+Generic+Synchronization[metaroles].
