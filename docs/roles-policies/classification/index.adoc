...
// TODO: add NDA (or internal employee status) as additional requirement for cat.III system (ISO27001 6.6)
// TIP: Internal employee archetype may include (induce) NDA clearance, as employees have non-disclosure clauses in their employment contracts.
