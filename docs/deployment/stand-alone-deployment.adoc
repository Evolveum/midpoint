...
Please have a look at the wiki:Trying+MidPoint[Trying MidPoint] page for basic installation instruction for the purposes of midPoint evaluation or demo.
See wiki:Installing+MidPoint+Server[Installing MidPoint Server] page for full installation instructions.
...
| `var`
| Default wiki:MidPoint+Home+Directory[midPoint home directory]. Initial configuration, cryptographic keys, log files and similar "variable" content.
| Read-write
| See wiki:MidPoint+Home+Directory[MidPoint Home Directory].
...
The database files will be stored in wiki:MidPoint+Home+Directory[midPoint home directory].
