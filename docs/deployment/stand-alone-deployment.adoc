...
Please have a look at the xref:/midpoint/get-started/quick-start/[] page for basic installation instruction for the purposes of midPoint evaluation or demo.
See xref:/midpoint/get-started/install/bare-installation/distribution/[Installing MidPoint Server] page for full installation instructions.
...
See also xref:/midpoint/get-started/install/bare-installation/midpoint-sh/[midpoint.sh page].
...
MidPoint comes with native PostgreSQL repository implementation.
...
* xref:/midpoint/get-started/install/[]
