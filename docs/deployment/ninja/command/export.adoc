...
** Full list of supported types can be found in link:https://evolveum.com/downloads/midpoint/4.10/midpoint-4.10-schemadoc/http---midpoint-evolveum-com-xml-ns-public-common-common-3/index.html[Midpoint schema reference].
