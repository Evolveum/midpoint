...
// TODO: It would be more suitable to structure this page as classic manpage - command; description; options and flags with their descriptions; examples
// TODO: I am missing info where this `doc` directory is located.
...
[NOTE]
====
The script set specified using the `--scripts` option does not need to be located in `doc/config/sql/native/`.
Any SQL script accessible by the midPoint deployment can be executed.
====
