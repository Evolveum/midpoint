...
Ninja only supports upgrading deployments that use xref:/midpoint/reference/repository/native-postgresql/[native repository].

For specific examples of upgrade scenarios, see <<Upgrade procedure examples>>.
