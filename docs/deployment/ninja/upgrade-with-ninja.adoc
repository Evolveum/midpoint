...
Preparation phase can be executed on running midPoint instance, without any interruption of service.
Upgrade phase requires downtime of midPoint instance.
Second phase should be quick to minimize required downtime.
