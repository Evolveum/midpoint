...
The names and types of the properties are defined by the wiki:Resource+and+Connector+Schema+Explanation[connector schema] that is stored in xref:/midpoint/architecture/archive/data-model/midpoint-common-schema/connectortype/[connector object].
