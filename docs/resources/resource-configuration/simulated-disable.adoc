...
There are resources that natively support `administrativeStatus`xref:/midpoint/reference/concepts/activation/[activation property]. These resources can natively do enable/disable of accounts.
