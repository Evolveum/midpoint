...
For an administrator-oriented overview of the internal mechanics of this behavior, including the role of recompute triggers and the conditions under which deletion is postponed or skipped, see xref:/midpoint/reference/concepts/activation/delayed-delete/[Delayed Delete].
