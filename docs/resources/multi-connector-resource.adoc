...
Let's have a big LDAP server with "NIS" schema (link:https://www.ietf.org/rfc/rfc2307.txt[RFC2307]). MidPoint is an xref:/reference/samples/story-tests/unix/[excellent choice] to manage such a system.
