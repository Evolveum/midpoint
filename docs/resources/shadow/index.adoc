...
The connector will announce the identification mechanism in the wiki:Resource+Schema[Resource Schema] using the wiki:Schema+Handling[Resource Schema Annotations].
