...
In fact, audit log can give you more complete information about errors than the actual task errors listing described above because audit log does not trim previous records for repeated errors of the same kind. 
