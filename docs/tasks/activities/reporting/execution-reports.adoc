...
[%autowidth]
|===
#,itemName,itemOid,bucketSequentialNumber,identifier,resourceRef,resourceRef-name,objectClass,operation,status,message,size,startTimestamp,startTimestamp-millis,endTimestamp,endTimestamp-millis,duration
...
[%autowidth]
|===
#,itemName,itemOid,bucketSequentialNumber,operation,qualifiers,operationKind,status,importance,asynchronousOperationReference,start,start-millis,end,end-millis,microseconds,cpuMicroseconds,invocationId,params,context,returns,token,messageCode,message,parent
...
| Looks like not filled in currently. #FIXME#
