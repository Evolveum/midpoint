...
For all the synchronization tasks to work correctly the xref:/midpoint/reference/resources/resource-configuration/schema-handling/#_synchronization[synchronization section]
of xref:/midpoint/reference/resources/resource-configuration/[resource configuration] must be set up properly.
See xref:/midpoint/reference/resources/resource-configuration/#_correlation_and_synchronization[Correlation and Synchronization] and xref:/midpoint/reference/resources/resource-configuration/schema-handling/#_synchronization[Synchronization Configuration] pages for more details.
====
...
using xref:/midpoint/reference/tasks/activities/resource-object-set-specification/[these settings].
