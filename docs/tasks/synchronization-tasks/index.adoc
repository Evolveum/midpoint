...
xref:/midpoint/reference/resources/shadow/kind-intent-objectclass/[object class, and/or kind and intent].
...
Import is usually a one-time activity that imports accounts (or other kind of resource objects) into midPoint.
