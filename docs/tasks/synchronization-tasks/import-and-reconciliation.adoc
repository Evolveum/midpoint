...
1. internal changes (deltas) used are different: "add" for import, no delta for reconciliation,footnote:[The real effects
...
2. `#reconciliation` channel value is used instead of the `#import` one.
