...
MidPoint has several built-in object types such as wiki:Advanced+Hybrid+RBAC[roles], xref:/midpoint/reference/org/organizational-structure/[orgs], and wiki:Services[services]. Those object types may look innocent at the first sight.
