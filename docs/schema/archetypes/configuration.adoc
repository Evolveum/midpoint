...
Archetypes can be added to menus and other places of midPoint interface by using xref:/midpoint/reference/admin-gui/collections-views/[object views]. All that is needed is simple definition of a view in wiki:Admin+GUI+Configuration[admin GUI configuration structure]:
