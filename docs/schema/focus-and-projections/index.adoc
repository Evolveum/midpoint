...
The common thing that all focal objects have are wiki:Assignment[assignments] and the ability to be owners of xref:/midpoint/reference/resources/shadow/[shadow objects] (they have an ability to wiki:Assigning+vs+Linking[link]).
