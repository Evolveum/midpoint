...
We would need to use Resource template feature (bug:MID-1653[]). Until it is ready, however, we do a small workaround by creating resource object by simply copying the "master".
