...
The inducement specifies an xref:/midpoint/reference/resources/shadow/kind-intent-objectclass/[(kind, intent)] tuple which is used to locate a matching definition in the schemaHandling.
