...
This is still quite general and it still works with relative information (wiki:Triple[triples] and xref:/midpoint/devel/prism/concepts/deltas/[deltas]). This provides a lot of output.
