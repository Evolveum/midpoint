...
This may seem simple, but the real power in using sequences are in combination with wiki:Mappings+and+Expressions[Mappings and Expressions]. The sequence can easily be used in a mapping:
