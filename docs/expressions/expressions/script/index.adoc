...
xref:groovy[Groovy] is good choice for scripts that need to do powerful computation or heavy customization.
...
xref:groovy[Groovy] and the other general-purpose scripting languages (JavaScript/ECMAscript, Python, etc.) are way too powerful.
