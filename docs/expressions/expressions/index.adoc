...
If you extend your assignments using xref:/schema/custom-schema-extension/changing-schema-extension-via-GUI/[custom schema extension], you can address the assignment extension properties during assignments:
