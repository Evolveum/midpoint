...
The object should be provided as _root node_ of the expression (see xref:/midpoint/reference/expressions/expressions/#root-node[Root Node] for details), which is usually the xref:/midpoint/reference/schema/focus-and-projections/[focus] of the processing.
