...
In that respect, expression profile are an _orthogonal_ mechanisms to authorizations, providing additional security layer.
In practice, xref:/midpoint/reference/expressions/expressions/security/[coordinated use of expression profiles and authorizations] is necessary to create safe configuration.

See xref:/midpoint/reference/expressions/expressions/security/[Expression Security] for details.
