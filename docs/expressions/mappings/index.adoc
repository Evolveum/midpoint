...
It is used for example in wiki:Outbound+Mapping[outbound mapping], wiki:Inbound+Mapping[inbound mapping], wiki:Assignment[assignments], xref:/midpoint/reference/roles-policies/rbac/[roles] and so on.
