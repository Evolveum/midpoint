...
| Paths to include | `intent` | to avoid showing other changes, e.g. those of synchronization timestamps
...
To simulate the execution of mappings in background task, let us import the link:https://github.com/Evolveum/midpoint-samples/tree/master/samples/simulation/tutorial/task-hr-import-simulation.xml[full simulation task].
...
image::result-after-first-correlation-object-details.png[Correlated account details]
...
image::shadows-after-first-correlation.png[Content of LDAP resource after initial correlation run]
...
.Correlated account details
image::result-after-second-correlation-object-details.png[Correlated account details]
...
image::shadows-after-first-import.png[LDAP shadows after the first import]
...
image::shadows-after-second-import.png[LDAP shadows after the second import]
...
.Temporary usernames
image::temporary-usernames.png[Temporary usernames]
...
image::renamed-users-result.png[Simulation result after simulated import of usernames]

We see 5 "focus renamed" events, so let us have a look.

.Simulation result objects
image::renamed-users-objects.png[Simulation result objects]

.Simulation result object details
image::renamed-users-object-details.png[Simulation result object details]
