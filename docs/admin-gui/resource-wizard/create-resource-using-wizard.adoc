...
When you create a new resource, you typically use the _Proposed_ lifecycle state for the resource.

Once you are done with all the configuration and testing, you need to put the whole resource to production.
...
You can also check and selectively adjust lifecycle states for any of the resource configurations, such as mapping rules or synchronization reactions:
