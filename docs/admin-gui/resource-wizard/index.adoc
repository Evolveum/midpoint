...
image::step-1-type-of-resource.png[100%, title=Type of resource]
...
image::step-1-basic-conf.png[100%, title=Basic configuration]
...
image::choice-part-resource.png[100%,title=Resource created - next steps]
...
image::data-preview-resource.png[100%,title=Resource Data preview]
...
image::step-2-object-type-table.png[100%,title=Table of object types]
...
image::choice-part-object-type.png[100%,title=Parts of object type configuration]
...
image::data-preview-object-type.png[100%,title=Data preview of object type]
...
image::step-3-mappings-inbound.png[100%, title=Table of inbound mappings]
...
|===
| image::step-3-mappings-inbound-detail-main.png[100%, title=Main configuration of inbound mapping (complex view)]
| image::step-3-mappings-inbound-detail-optional.png[100%, title=Optional configuration of inbound mapping (complex view)]
|===
...
image::step-3-mappings-outbound.png[100%, title=Table of outbound mappings]
...
[%autowidth, cols="a,a", frame=none, grid=none, role=center]
|===
| image::step-3-mappings-outbound-detail-main.png[100%, title=Main configuration of outbound mapping (complex view)]
| image::step-3-mappings-outbound-detail-optional.png[100%, title=Optional configuration of outbound mapping (complex view)]
|===
...
| image::step-3-mappings-override-detail-basic.png[100%, title=Detailed configuration of attribute override configuration]
| image::step-3-mappings-override-detail-limitations.png[100%, title=Detailed configuration of attribute override - limitations configuration]
|===
...
image::step-4-synch.png[100%,title=Table of synchronization actions]
...
image::step-5-correlator-rule.png[100%,title=Table of correlation rules]
...
image::step-5-correlator-item.png[100%,title=Table of correlation items for one correlation rule]
...
image::step-6-capabilities.png[100%,title=Capabilities configuration]
...
| image::step-7-activation-inbound-full.png[100%, title=Activation table with inbound mapping for administrative status]
...
| image::step-7-activation-outbound-full.png[100%, title=Activation table with outbound mapping for administrative status and predefined mappings for 'Disable instead of delete' and 'Delayed delete' configuration]
|===

Predefined mapping configurations contain only one configuration step.

.Predefined details configuration for 'Delayed delete'
image::step-7-predefined-details.png[100%,title=Predefined details configuration for 'Delayed delete']
...
image::step-8-credentials.png[100%,title=Configuration of credentials]
...
image::step-9-association.png[100%,title=Table of associations]
...
image::task-wizard-step-1-select-task-type.png[100%,title=Step 1: Select task type]
...
image::task-wizard-step-2-basic.png[100%,title=Step 2: Enter basic task information]
...
image::task-wizard-step-3-resource.png[100%,title=Step 3: Enter resource-related task information]
...
image::task-wizard-step-4-distribution.png[100%,title=(Optional) Step 4: Enter distribution details]
...
image::task-wizard-step-1-select-task-type-simulated.png[100%,title=Step 1: Select task type (with simulation)j]
...
image::task-wizard-step-2-basic-simulated.png[100%,title=Step 2: Enter basic task information]
...
image::task-wizard-step-3-resource-simulated.png[100%,title=Step 3: Enter resource-related task information]
...
image::task-wizard-step-4-execution-simulated.png[100%,title=Step 4: Enter execution-related task information]
...
image::task-wizard-step-5-schedule-simulated.png[100%,title=(Optional) Step 5: Enter scheduling-related task information]
...
image::task-wizard-step-4-distribution.png[100%,title=(Optional) Step 6: Enter distribution details]
