...
|===
| image::step-2-object-type-basic-config.png[title=Basic configuration of object type]
| image::step-2-object-type-resource-data.png[title=Resource data]

2+| image::step-2-object-type-resource-data.png[title=Midpoint data, 50%]
|===
...
[%autowidth, cols="a,a", frame=none, grid=none, role=center]
|===
| image::step-3-mappings-inbound.png[title=Table of inbound mappings]
| image::step-3-mappings-inbound-detail.png[title=Detail configuration of inbound mapping]
|===
...
[%autowidth, cols="a,a", frame=none, grid=none, role=center]
|===
| image::step-3-mappings-outbound.png[title=Table of outbound mappings]
| image::step-3-mappings-outbound-detail.png[title=Detail configuration of outbound mapping]
|===
...
2+| image::step-3-mappings-override.png[title=Table of attribute overrides]

| image::step-3-mappings-override-detail-basic.png[title=Detail configuration of attribute override]
| image::step-3-mappings-override-detail-limitations.png[title=Detail configuration of attribute override limitations]
|===
...
[%autowidth, cols="a,a", frame=none, grid=none, role=center]
|===
| image::step-4-synch-detail-basic.png[title=Basic configuration of synchronizatio rule]
| image::step-4-synch-detail-action.png[title=Action for synchronization rule]

| image::step-4-synch-detail-optional.png[title=optional attributes for synchronization rule]
|
|===
...
[%autowidth, cols="a,a", frame=none, grid=none, role=center]
|===
| image::step-7-activation-admin-status.png[title=Configuration of administrative status]
| image::step-7-activation-existence.png[title=Configuration of existence]

| image::step-7-activation-valid-from.png[title=Configuration of valid from]
| image::step-7-activation-valid-to.png[title=Configuration of valid to]

| image::step-7-activation-lockout-status.png[title=Configuration of lockout status]
|
|===
