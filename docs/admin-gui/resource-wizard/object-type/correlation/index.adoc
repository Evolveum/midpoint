...
While not strictly required, inbound mapping allows you to reuse mapped attributes as xref:/midpoint/reference/correlation/items-correlator[correlation items].
