...
The plan is that collections could be used in the entire midPoint system, e.g., in xref:/midpoint/reference/security/authorization/[authorizations], that xref:/midpoint/reference/roles-policies/policy-rules/[policy rules] may be applied to them, and so on.
