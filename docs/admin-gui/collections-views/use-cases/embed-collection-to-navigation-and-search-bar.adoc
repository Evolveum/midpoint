...
image::allUsersCustomManagers.png["Custom quick search filter active in the search bar for All Users"]

.The custom quick search filter in the search bar for "All Users" is active
image::managersOnly.png["Custom quick search filter is active"]
