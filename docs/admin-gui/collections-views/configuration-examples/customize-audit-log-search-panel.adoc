...
:page-moved-from: /midpoint/reference/admin-gui/collections-views/example-audit-search/
...
// Hide this page because the configurations do not work in modern (4.8+) midPoint versions and need to be adjusted
// JiriL tested this and it works on MP 4.3.1
