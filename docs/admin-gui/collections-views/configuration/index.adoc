...
The list below shows a list of the main menu tabs that have expandable submenu options.
...
1. Define the ObjectCollection that queries the items for the submenu.

2. Add an objectCollectionView to the systemConfiguration to create the menu item and link it to the collection.
