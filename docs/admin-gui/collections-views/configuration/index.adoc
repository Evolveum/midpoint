...
Use case for such search configuration is described more detailed xref:../../admin-gui-config/admin-gui-config-examples/#configure-fulltext-search-item-on-the-members-basic-search-panel[here].
