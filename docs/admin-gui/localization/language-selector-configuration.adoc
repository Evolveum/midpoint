...
The https://github.com/Evolveum/midpoint-localization/blob/master/localization/locale.properties[default list of national flags and languages] in the GUI locale selector can be overridden by a custom list.
...
If you define a custom list, you will see _only_ the languages defined in the custom list.
====
