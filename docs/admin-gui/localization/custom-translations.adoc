...
The property translations are placed in `.properties` files in the `${midpoint.home}/localization/` directory.
...
* Locale-specific variants, such as `Midpoint_en.properties`, `Midpoint_fr.properties`, etc.
