...
You can create a simple user statistics dashboard like the one below when you create object collections for various events happening to user objects and connect them to one dashboard.
