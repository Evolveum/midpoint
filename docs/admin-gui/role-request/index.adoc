...
xref:/midpoint/reference/roles-policies/policy-rules/[Policy rules] that apply to the roles are evaluated and enforced and the request is routed through an wiki:Approval[approval process] as specified by the policy.
