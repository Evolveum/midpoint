...
Most important (and actually supported) attributes are described bellow:
...
* wiki:Self+Registration+Configuration[Configuring self-registraion]

* wiki:Reset+Password+Configuration[Configuring reset password]
