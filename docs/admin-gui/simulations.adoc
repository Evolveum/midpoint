...
:page-description: This article describes usage of the midPoint simulation feature in the graphical user interface.
:page-keywords: simulation, test, testing, preview, development environment, task, activity, preview mode, development configuration, gui, simulation result

== Introduction

This document describes user interface for feature called simulation.
...
* Event marks - metrics counted based on predefined event marks. To see more about event marks, check xref:/midpoint/reference/concepts/mark/event-marks.adoc[event marks].
