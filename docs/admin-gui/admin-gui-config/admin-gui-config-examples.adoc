...
All accesses panel displays all direct and indirect assignments in more "business" language. It displays how the assignment was assigned and why.
...
But, not every assignment of role may represent access. E.g. assignment with relation owner may or may not define access. This depends on your organization environment.
