...
_availablePageSize_ Defines a set of available page size values which will be suggested to the user on the table panels.

_defaultPageSize_ Defines the value for the default page size.
This value can be one of those defined in availablePageSize set or any other value (will be added then to the list of the available page sizes).
