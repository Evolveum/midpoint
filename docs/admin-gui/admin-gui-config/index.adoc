...
Panel for wizard contains same configuration structure as xref:/midpoint/reference/admin-gui/admin-gui-config/#panel-configuration[panel configuration].Only configuration for containers is supported and was tested. We can use container konfiguration for wizard panel which show panel with form.
