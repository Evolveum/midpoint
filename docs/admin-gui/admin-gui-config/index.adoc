...
To learn more about default object details configuration, see chapter xref:#_object_details_default_settings[Object details default settings].
...
[#_object_details_default_settings]
=== Object details default settings

Default settings are aimed to easily apply some common configuration to all details pages within midPoint.
...
All default settings can be overridden in the concrete object details page configuration.
