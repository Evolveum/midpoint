...
(More information on this topic can be found e.g. on wiki:Relation[Relation] and xref:/midpoint/reference/concepts/relation/relation-configuration/[Relation Configuration] pages.)
