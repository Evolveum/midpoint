...
And actually the extremely poweful xref:/midpoint/reference/roles-policies/roles/rbac/[RBAC] mechanism can also be reused for these unusual links creating a kind of meta-roles.
