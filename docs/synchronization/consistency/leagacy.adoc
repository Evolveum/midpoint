...
Consistency mechanism was significantly improved in midPoint 3.9. Please see wiki:Consistency+mechanism[Consistency mechanism] page for up-to-date information.
