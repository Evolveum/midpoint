...
//			delta.getItemNew()
//			TODO: swhich to the value serialization util
			
//			return ValueSerializationUtil.serializeItemValue(ItemDeltaType.F_VALUE, delta.getDefinition(), value, prismContext, PrismContext.LANG_XML);
