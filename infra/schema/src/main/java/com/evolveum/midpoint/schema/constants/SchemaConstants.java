...
public abstract class SchemaConstants {
	...
	public static final QName C_FILTER_TYPE = new QName(NS_QUERY, "type");
	public static final QName C_FILTER_TYPE_URI = new QName(NS_QUERY, "uri");
	public static final QName C_FILTER_EQUAL = new QName(NS_QUERY, "equal");
	public static final QName C_FILTER_PATH = new QName(NS_QUERY, "path");
	public static final QName C_FILTER_VALUE = new QName(NS_QUERY, "value");
	public static final QName C_FILTER_AND = new QName(NS_QUERY, "and");
