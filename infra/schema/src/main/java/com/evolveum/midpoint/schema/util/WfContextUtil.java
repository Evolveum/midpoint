...
//	}
	...
	public static WfContextType getWorkflowContext(WorkItemType workItem) {
		PrismContainerValue<?> parent = PrismContainerValueImpl.getParentContainerValue(workItem.asPrismContainerValue());
		if (parent == null) {
	...
	public static TaskType getTask(WfContextType wfc) {
		...
		PrismContainerValue<?> parent = PrismContainerValueImpl.getParentContainerValue(wfc.asPrismContainerValue());
		if (parent == null) {
