...
public enum ObjectTypes {
    ...
    ACCESS_CERTIFICATION_TYPE(AccessCertificationTypeType.COMPLEX_TYPE, SchemaConstantsGenerated.C_ACCESS_CERTIFICATION_TYPE, AccessCertificationTypeType.class,
            ObjectManager.MODEL, "accessCertificationTypes"),

    ACCESS_CERTIFICATION_RUN(AccessCertificationRunType.COMPLEX_TYPE, SchemaConstantsGenerated.C_ACCESS_CERTIFICATION_RUN, AccessCertificationRunType.class,
            ObjectManager.MODEL, "accessCertificationRuns"),
