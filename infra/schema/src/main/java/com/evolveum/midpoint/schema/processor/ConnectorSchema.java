...
public class ConnectorSchema extends PrismSchema {
	...
	public ConnectorSchema(String namespace, PrismContext prismContext) {
		super(namespace, prismContext);
	}
	
	public static ConnectorSchema parse(Element element, String shortDesc, PrismContext prismContext) throws SchemaException {
		// TODO: make sure correct parser plugins are used
		return (ConnectorSchema) PrismSchema.parse(element, new ConnectorSchema(prismContext), true, shortDesc, prismContext);
	}
