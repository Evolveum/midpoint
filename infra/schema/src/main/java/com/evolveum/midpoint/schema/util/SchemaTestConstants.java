...
public class SchemaTestConstants {
	...
	public static final PropertyPath ICFS_UID_PATH = new PropertyPath(ResourceObjectShadowType.F_ATTRIBUTES, ICFS_UID);
	public static final QName ICFS_NAME = new QName(NS_ICFS, "name");
	public static final PropertyPath ICFS_NAME_PATH = new PropertyPath(ResourceObjectShadowType.F_ATTRIBUTES, ICFS_NAME);
