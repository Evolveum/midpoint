...
public interface PrismSerializer<T> {
	...
	<C extends Containerable> T serialize(PrismContainerValue<C> pcv) throws SchemaException;
	<C extends Containerable> T serializeAtomicValue(Object value) throws SchemaException;
	<C extends Containerable> T serializeAnyData(Object value) throws SchemaException;
}
