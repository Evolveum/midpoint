...
import com.evolveum.midpoint.prism.parser.json.yaml.MidpointYAMLFactory;
import com.evolveum.midpoint.prism.parser.json.yaml.MidpointYAMLGenerator;
import com.evolveum.midpoint.prism.parser.json.yaml.MidpointYAMLParser;
...
public class YamlParser extends AbstractJsonParser {
...
//            String oid = p.getObjectId();
	...
	@Override
	protected QName tagToTypeName(Object tag, AbstractJsonParser.JsonParsingContext ctx) throws IOException, SchemaException {
		if (tag == null) {
			return null;
