    ...
    private static void copyFilter(final List<Element> source, final List<Element> target) {
        ...
        if ((source!= null)&&(!source.isEmpty())) {
            for (final Iterator<?> it = source.iterator(); it.hasNext(); ) {
                ...
                throw new AssertionError((("Unexpected instance '"+ next)+"' for property 'Filter' of class 'com.evolveum.prism.xml.ns._public.query_2.NAryLogicalOperatorFilterType'."));
            }
        }
    }
