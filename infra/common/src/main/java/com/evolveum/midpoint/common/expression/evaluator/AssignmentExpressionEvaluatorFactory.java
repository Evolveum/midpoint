...
public class AssignmentExpressionEvaluatorFactory implements ExpressionEvaluatorFactory {
	...
	public QName getElementName() {
		return new ObjectFactory().createAssignmentExpression(new AssignmentExpressionEvaluatorType()).getName();
	}
	 ...
	 */
	@Override
	public <V extends PrismValue> AssignmentExpressionEvaluator<V> createEvaluator(Collection<JAXBElement<?>> evaluatorElements, 
        ...
        if (evaluatorTypeObject != null && !(evaluatorTypeObject instanceof AssignmentExpressionEvaluatorType)) {
