...
public class JAXBUtil2 {
	...
	private static final Trace TRACE = TraceManager.getTrace(JAXBUtil2.class);
	...
	public static final Object unmarshal(String xmlString) throws JAXBException {
		if (xmlString == null) {
			throw new IllegalArgumentException("Can't parse null xml string.");
		}

		xmlString = xmlString.trim();
		if (!xmlString.startsWith("<") || !xmlString.endsWith(">")) {
			throw new IllegalArgumentException("Not an xml string (doesn't start with < and finish with >.");
		}
