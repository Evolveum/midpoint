 ...
 * generated in the com.evolveum.prism.xml.ns._public.types_4 package.
...
public class ObjectFactory implements Serializable {
    ...
    private final static QName _ObjectDelta_QNAME = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "objectDelta");
    private final static QName _PolyStringTypeNorm_QNAME = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "norm");
    private final static QName _PolyStringTypeOrig_QNAME = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "orig");
    private final static QName _ProtectedDataTypeEncryptedData_QNAME = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "encryptedData");
    private final static QName _ProtectedDataTypeHashedData_QNAME = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "hashedData");
    private final static QName _ItemPathType_QNAME = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "path");
    private final static QName _Object_QNAME = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "object");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.evolveum.prism.xml.ns._public.types_4
     *
     */
...
//    }
     ...
     *
     */
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4", name = "objectDelta")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4", name = "norm", scope = PolyStringType.class)
     ...
     *
     */
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4", name = "orig", scope = PolyStringType.class)
     ...
     *
     */
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4", name = "encryptedData", scope = ProtectedDataType.class)
    ...
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4", name = "encryptedData", scope = ProtectedStringType.class)
     ...
     *
     */
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4", name = "hashedData", scope = ProtectedDataType.class)
    ...
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4", name = "hashedData", scope = ProtectedStringType.class)
    ...
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4", name = "path", scope = ItemPathType.class)
     ...
     *
     */
    @XmlElementDecl(namespace = "http://prism.evolveum.com/xml/ns/public/types-4a", name = "object")
