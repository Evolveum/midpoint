 ...
 *       &lt;sequence&gt;
 *         &lt;element name="orderBy" type="{http://prism.evolveum.com/xml/ns/public/types-4}XPathType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="groupBy" type="{http://prism.evolveum.com/xml/ns/public/types-4}XPathType" minOccurs="0"/>
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PagingType implements Serializable, Cloneable, Equals, HashCode
{
    ...
    public PagingType(final PagingType o) {
        ...
        // CEnumLeafInfo: com.evolveum.prism.xml.ns._public.query_4.OrderDirectionType
