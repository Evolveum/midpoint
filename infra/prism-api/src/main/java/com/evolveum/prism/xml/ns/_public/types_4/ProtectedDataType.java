...
public abstract class ProtectedDataType<T> implements ProtectedData<T>, Serializable {
	...
	public static final QName COMPLEX_TYPE = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "ProtectedDataType");
	public final static QName F_ENCRYPTED_DATA = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "encryptedData");
	public final static QName F_HASHED_DATA = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "hashedData");
	public final static QName F_CLEAR_VALUE = new QName("http://prism.evolveum.com/xml/ns/public/types-4", "clearValue");
    ...
    @XmlElementRef(name = "encryptedData", namespace = "http://prism.evolveum.com/xml/ns/public/types-4", type = JAXBElement.class)
    @XmlMixed
