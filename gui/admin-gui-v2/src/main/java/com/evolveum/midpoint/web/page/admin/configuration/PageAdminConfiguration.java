...
public class PageAdminConfiguration extends PageAdmin {
    ...
    public List<BottomMenuItem> getBottomMenuItems() {
        ...
        items.add(new BottomMenuItem("pageAdminConfiguration.importFromXml", PageLogging.class));
        items.add(new BottomMenuItem("pageAdminConfiguration.importFromFile", PageLogging.class));
