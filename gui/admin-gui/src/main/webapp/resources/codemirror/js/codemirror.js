...
var CodeMirror = (function() {
    ...
    setDefaults(CodeMirrorConfig, {
        ...
        path: "",
        parserfile: [],
        basefiles: ["util.js.iface", "stringstream.js.iface", "select.js.iface", "undo.js.iface", "editor.js.iface", "tokenize.js.iface"],
        iframeClass: null,
        passDelay: 200,
        passTime: 50,
        lineNumberDelay: 200,
    ...
    CodeMirror.prototype = {
        ...
        selection: function() {
            this.focusIfIE(); return this.editor.selectedText();
        },
        reindent: function() {
            this.editor.reindent();
        },
        reindentSelection: function() {
            this.focusIfIE(); this.editor.reindentSelection(null);
        },
        ...
        cursorPosition: function(start) {
            this.focusIfIE(); return this.editor.cursorPosition(start);
        },
        firstLine: function() {
