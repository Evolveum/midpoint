...
/**
 * @deprecated there are too many info box implementations in crazy inheritance hierarchies
 * {@link com.evolveum.midpoint.web.component.box.InfoBoxPanel} and {@link SmallInfoBoxPanel}?
 * They are unrelated in terms of HTML.
 *
 * {@link com.evolveum.midpoint.web.component.box.InfoBoxPanel} and subclasses - copying HTML multiple times
 *
 *
 * @author skublik
 */
@Deprecated
public abstract class InfoBoxPanel2 extends BasePanel<DashboardWidgetType> {
    private static final long serialVersionUID = 1L;

    private static final Trace LOGGER = TraceManager.getTrace(InfoBoxPanel2.class);
    ...
    public InfoBoxPanel2(String id, IModel<DashboardWidgetType> model) {
        super(id, model);
