...
public class MiningBasicDetailsPanel extends BasePanel<String> implements Popupable {

    private static final String ID_BUTTON_OK = "ok";
    private static final String ID_CANCEL_OK = "cancel";


    public MiningBasicDetailsPanel(String id, IModel<String> messageModel, IModel<SelectableBean<MiningType>> rowModel) {
