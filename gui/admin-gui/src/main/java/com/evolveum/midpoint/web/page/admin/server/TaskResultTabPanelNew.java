 ...
 * @author semancik
 */
public class TaskResultTabPanelNew extends BasePanel<PrismObjectWrapper<TaskType>> implements TaskTabPanel {
    ...
    private static final Trace LOGGER = TraceManager.getTrace(TaskResultTabPanelNew.class);

    public TaskResultTabPanelNew(String id, LoadableModel<PrismObjectWrapper<TaskType>> taskWrapperModel) {
...
//        resultTablePanel.setOutputMarkupId(true);
        ...
        AjaxFallbackLink<Void> showResult = new AjaxFallbackLink<Void>(ID_SHOW_RESULT) {
            ...
            public void onClick(Optional<AjaxRequestTarget> optionalTarget) {
                ...
                PrismObjectWrapper<TaskType> taskWrapper = TaskResultTabPanelNew.this.getModelObject();
