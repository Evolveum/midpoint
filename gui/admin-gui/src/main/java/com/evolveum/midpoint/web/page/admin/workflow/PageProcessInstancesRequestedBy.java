 ...
 * @author mederly
 */
@PageDescriptor(url = "/admin/myRequests", action = {
        ...
        @AuthorizationAction(actionUri = AuthorizationConstants.AUTZ_UI_MY_REQUESTS_URL,
                label = "PageProcessInstancesRequestedBy.auth.myRequests.label",
                description = "PageProcessInstancesRequestedBy.auth.myRequests.description")})
