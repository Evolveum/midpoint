...
public class SidebarPanel extends BasePanel<Void> {

    private static final String ID_MENU = "menu";
    private static final Trace LOGGER = TraceManager.getTrace(SidebarPanel.class);

    private static final String DOT_CLASS = SidebarPanel.class.getName() + ".";
    ...
    private void initLayout() {
        ...
        add(new AttributeAppender("style", new IModel<String>() {
...
//        }
    ...
    private MainMenuItem createRepositoryObjectsMenu() {
        MainMenuItem repositoryObjectsMenu = createMainMenuItem("PageAdmin.menu.top.configuration.repositoryObjects", "far fa-file-alt");
    ...
    private MenuItem createObjectListPageMenuItem(String key, String iconClass, Class<? extends PageBase> menuItemPage) {
        ...
        return new MenuItem(key, iconClass, menuItemPage) {
            ...
            public boolean isMenuActive(WebPage page) {
                ...
                if (!page.getClass().equals(this.getPageClass()) || pageParameters != null && pageParameters.get(PageParameterConstants.PARAMETER_OBJECT_COLLECTION_NAME) != null
                        && StringUtils.isNotEmpty(pageParameters.get(PageParameterConstants.PARAMETER_OBJECT_COLLECTION_NAME).toString())
                        && !pageParameters.get(PageParameterConstants.PARAMETER_OBJECT_COLLECTION_NAME).toString().equals("null")) {
                    return false;
                } else {
    ...
    private void addCollectionsMenuItems(MainMenuItem mainMenuItem, QName type, Class<? extends PageBase> redirectToPage) {
        ...
        objectViews.forEach(objectView -> {
            ...
            PageParameters pageParameters = new PageParameters();
            pageParameters.add(PageParameterConstants.PARAMETER_OBJECT_COLLECTION_NAME, objectView.getViewIdentifier());
...
//        return collectionMenuItems;
    ...
    private boolean isObjectCollectionMenuActive(CompiledObjectCollectionView objectView) {
        ...
        StringValue collectionNameParam = params.get(PageParameterConstants.PARAMETER_OBJECT_COLLECTION_NAME);
