...
public class AssociationsWizardPanel extends AbstractResourceWizardPanel<ResourceObjectTypeDefinitionType> {
    ...
    protected void initLayout() {
        add(createWizardFragment(new WizardPanel(
                getIdOfWizardPanel(),
                new WizardModel(createAssociationsSteps(getValueModel())))));
    }
    ...
    private List<WizardStep> createAssociationsSteps(IModel<PrismContainerValueWrapper<ResourceObjectTypeDefinitionType>> valueModel) {
        List<WizardStep> steps = new ArrayList<>();
        AssociationsStepPanel panel = new AssociationsStepPanel(
                getResourceModel(),
