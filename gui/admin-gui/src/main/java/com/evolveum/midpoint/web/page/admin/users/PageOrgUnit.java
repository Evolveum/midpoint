...
public class PageOrgUnit extends PageAdminFocus implements ProgressReportingAwarePage {
...
//			@Override
//			public List<AssignmentType> getAssignmentTypeList() {
//				return ((FocusType) getFocusWrapper().getObject().asObjectable()).getAssignment();
//			}
//
//			@Override
//			public String getExcludeOid() {
...
//	}
	...
	protected void savePerformed(AjaxRequestTarget target) {
		...
		ObjectWrapper orgWrapper = getFocusWrapper();
	...
	private List<ObjectDelta<? extends ObjectType>> modifyShadows(OperationResult result) {
		...
		List<FocusShadowDto> shadows = getFocusShadows();
...
//	}
	...
	private List<OrgType> loadParentOrgUnits() {
		...
		OrgType actOrg = (OrgType) getFocusWrapper().getObject().asObjectable();
