...
public class OutlierAttributeItemPanel<T extends Serializable>
    ...
    private @NotNull Component buildDetailsPanel(@NotNull String id) {
        ...
        RoleAnalysisAttributePanel detailsPanel = loadDetailsPanel(id, task);
        detailsPanel.setOutputMarkupId(true);
        return detailsPanel;
    }

    @NotNull
    private RoleAnalysisAttributePanel loadDetailsPanel(@NotNull String id, Task task) {
        ...
        RoleAnalysisAttributePanel roleAnalysisAttributePanel = new RoleAnalysisAttributePanel(id,
