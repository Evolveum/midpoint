...
public class CorrelationUtil {
    ...
    public enum CorrelationStatus {
        CORRELATED("badge text-bg-success opaque", "Correlation.simulation.state.correlated"),
        UNCERTAIN("badge text-bg-warning opaque", "Correlation.simulation.state.uncertain"),
        NOT_CORRELATED("badge text-bg-secondary opaque", "Correlation.simulation.state.notCorrelated");
