...
public class GenerateDataPanel extends BasePanel<String> implements Popupable {
    ...
    public GenerateDataPanel(String id, IModel<String> messageModel, List<PrismObject<UserType>> users,
            List<PrismObject<RoleType>> roles) {
        super(id, messageModel);

        initLayout(users, roles);
    }
    ...
    private void initLayout(List<PrismObject<UserType>> users, List<PrismObject<RoleType>> roles) {
