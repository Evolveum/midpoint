 ...
 * }</pre>
 */
public class RoleAnalysisCardTablePanel<T> extends BasePanel<T> implements Table {
    ...
    public RoleAnalysisCardTablePanel(String id, ISortableDataProvider<T, String> provider, List<IColumn<T, String>> columns) {
    ...
    private void initLayout(List<IColumn<T, String>> columns, ISortableDataProvider<T, String> provider) {
        ...
        CardDataTable<T, String> table = new CardDataTable<>(ID_TABLE, columns, provider, pageSize);
    ...
    protected WebMarkupContainer createFooter() {
        return new PagingFooter(RoleAnalysisCardTablePanel.ID_FOOTER, ID_PAGING_FOOTER, this, this) {

            @Override
            protected String getPaginationCssClass() {
                return RoleAnalysisCardTablePanel.this.getPaginationCssClass();
            }

            @Override
            protected boolean isPagingVisible() {
                return RoleAnalysisCardTablePanel.this.isPagingVisible();
            }
        };
    }
    ...
    private static class PagingFooter extends Fragment {
        ...
        public PagingFooter(String id, String markupId, RoleAnalysisCardTablePanel markupProvider, Table table) {
        ...
        private void initLayout(final RoleAnalysisCardTablePanel<?> boxedTablePanel, final Table table) {
            ...
            NavigatorPanel nb2 = new NavigatorPanel(ID_PAGING, dataTable, true) {
                ...
                @Override
                protected String getPaginationCssClass() {
                    return RoleAnalysisCardTablePanel.PagingFooter.this.getPaginationCssClass();
                }
            };
            ...
            PagingSizePanel menu = new PagingSizePanel(ID_PAGE_SIZE) {
                ...
                protected void onPageSizeChangePerformed(AjaxRequestTarget target) {
                    ...
                    target.add(findParent(RoleAnalysisCardTablePanel.PagingFooter.class));
