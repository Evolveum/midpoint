...
@PageDescriptor(
        urls = {
                @Url(mountUrl = "/admin/applicationService", matchUrlForSecurity = "/admin/applicationService")
        },
...
public class PageDefaultApplicationService extends PageApplicationService {
