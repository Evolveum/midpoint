...
import com.evolveum.midpoint.gui.impl.prism.ItemHeaderPanel;
 ...
 *
 */
public class PrismContainerHeaderPanel<C extends Containerable> extends ItemHeaderPanel<PrismContainerWrapper<C>>{
