...
public class NextConnectorDevPartItem extends AbstractWizardPartItem<ConnectorDevelopmentType, ConnectorDevelopmentDetailsModel> {

//    private static final Trace LOGGER = TraceManager.getTrace(NextConnectorDevStatusItem.class);

    protected NextConnectorDevPartItem(WizardPanelHelper<? extends Containerable, ConnectorDevelopmentDetailsModel> helper) {
        super(helper);
    }
    ...
    public Enum<?> getIdentifierForWizardStatus() {
        return ConnectorDevelopmentStatusType.NEXT;
    }
}
