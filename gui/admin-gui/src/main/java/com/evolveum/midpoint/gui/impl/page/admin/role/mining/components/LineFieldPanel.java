...
public class LineFieldPanel extends BasePanel<String> {

    private static final String ID_NAME = "name";
    private static final String ID_HELP = "help";
    private static final String ID_VALUE = "value";

    public LineFieldPanel(String id, IModel<String> model) {
        super(id, model);
    }
    ...
    private void initLayout() {
        ...
        TextField<String> textField = new TextField<>(ID_VALUE, getValueModel());
