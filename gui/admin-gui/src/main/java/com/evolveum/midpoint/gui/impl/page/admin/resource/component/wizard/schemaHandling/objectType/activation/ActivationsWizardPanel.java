...
public class ActivationsWizardPanel extends AbstractWizardPanel<ResourceActivationDefinitionType, ResourceDetailsModel> {

    public ActivationsWizardPanel(String id, WizardPanelHelper<ResourceActivationDefinitionType, ResourceDetailsModel> helper) {
        super(id, helper);
    }
    ...
    private ActivationMappingWizardPanel createActivationTablePanel(MappingDirection mappingDirection) {
        PrismContainerWrapperModel<ResourceActivationDefinitionType, ResourceActivationDefinitionType> containerModel =
