...
public class OrgTreePanel extends AbstractTreeTablePanel {
	...
	// InlineMenuItem(createStringResource("TreeTablePanel.collapseAll"),
	// new InlineMenuItemAction() {
	//
	// @Override
	// public void onClick(AjaxRequestTarget target) {
	...
	// items.add(item);
	// item = new
	// InlineMenuItem(createStringResource("TreeTablePanel.expandAll"),
	// new InlineMenuItemAction() {
	//
	// @Override
	// public void onClick(AjaxRequestTarget target) {
	...
	//
	// InlineMenuItem item = new
	// InlineMenuItem(createStringResource("TreeTablePanel.move"),
	...
	//
	// item = new
	// InlineMenuItem(createStringResource("TreeTablePanel.recompute"),
	// new ColumnMenuAction<SelectableBean<OrgType>>() {
	//
	// @Override
	// public void onClick(AjaxRequestTarget target) {
	...
	//
	// item = new
	// InlineMenuItem(createStringResource("TreeTablePanel.createChild"),
