 ...
 */
public class CustomTransportCounter extends SimpleCounter<AssignmentHolderDetailsModel<SystemConfigurationType>, SystemConfigurationType> {

    public CustomTransportCounter() {
        super();
    }
    ...
    public int count(AssignmentHolderDetailsModel<SystemConfigurationType> model, PageBase pageBase) {
        ...
        return mtc != null ? mtc.getCustomTransport().size() : 0;
    }
}
