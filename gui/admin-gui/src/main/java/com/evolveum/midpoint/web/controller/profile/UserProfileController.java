 ...
 */
package com.evolveum.midpoint.web.controller.profile;
...
public class UserProfileController implements Serializable {
	...
	public static final String PAGE_NAVIGATION = "/user-gui/profile/userProfile?faces-redirect=true";
	private static final Trace LOGGER = TraceManager.getTrace(UserProfileController.class);
