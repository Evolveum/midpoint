...
public class NotificationConfigPanel extends SimplePanel<NotificationConfigurationDto>{
	...
	protected void initLayout() {
		TextField<String> defaultFromField = WebMiscUtil.createAjaxTextField(ID_DEFAULT_FROM, new PropertyModel<String>(getModel(), "defaultFrom"));
        ...
        DropDownChoice mailServerConfigChooser = new DropDownChoice<>(ID_MAIL_SERVER,
                new PropertyModel<MailServerConfigurationTypeDto>(getModel(), NotificationConfigurationDto.F_SELECTED_SERVER),
        ...
        TextField<String> hostField = WebMiscUtil.createAjaxTextField(ID_HOST, new PropertyModel<String>(getModel(), "selectedServer.host"));
        TextField<Integer> portField = WebMiscUtil.createAjaxTextField(ID_PORT, new PropertyModel<Integer>(getModel(), "selectedServer.port"));
        TextField<String> userNameField = WebMiscUtil.createAjaxTextField(ID_USERNAME, new PropertyModel<String>(getModel(), "selectedServer.username"));
        ...
        TextField<String> redirectToFileField = WebMiscUtil.createAjaxTextField(ID_REDIRECT_TO_FILE, new PropertyModel<String>(getModel(), "redirectToFile"));
        ...
        DropDownFormGroup transportSecurity = new DropDownFormGroup<>(ID_TRANSPORT_SECURITY, new PropertyModel<MailTransportSecurityType>(getModel(),
                "selectedServer.mailTransportSecurityType"), WebMiscUtil.createReadonlyModelFromEnum(MailTransportSecurityType.class),
...
//        transportSecurity.add(new EmptyOnChangeAjaxFormUpdatingBehavior());
        ...
        removeMailServerConfig.add(new AttributeAppender("class", new AbstractReadOnlyModel<String>() {
            ...
            public String getObject() {
                if(getModelObject() != null &&
                        getModelObject().getSelectedServer() != null){
                    return null;
                } else {
                    return " disabled";
                }
