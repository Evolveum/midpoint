...
public class AjaxLinkIconPanel extends Panel {
    ...
    public AjaxLinkIconPanel(String id, IModel<?> labelModel, StringResourceModel popupText, DisplayType displayType) {
        super(id);
        ...
        AjaxLink<String> link = new AjaxLink<>(ID_LINK) {
            ...
            public void onClick(AjaxRequestTarget target) {
                AjaxLinkIconPanel.this.onClick(target);
            }
        ...
        link.add(label);
        link.add(new EnableBehaviour(AjaxLinkIconPanel.this::isEnabled));
