 ...
 */
public class SubSystemLoggersMenuLinkCounter extends SimpleCounter<AssignmentHolderDetailsModel<SystemConfigurationType>, SystemConfigurationType> {

    public SubSystemLoggersMenuLinkCounter() {
        super();
    }
