...
public class TaskMonitoringPanel extends AbstractObjectMainPanel<TaskType, ObjectDetailsModels<TaskType>> {
    ...
    public TaskMonitoringPanel(String id, ObjectDetailsModels<TaskType> model, ContainerPanelConfigurationType config) {
    ...
    protected void initLayout() {
        SingleContainerPanel activityDefinitionPanel = new SingleContainerPanel(ID_MAIN_PANEL,
                PrismContainerWrapperModel.fromContainerWrapper(getObjectWrapperModel(), ItemPath.create(TaskType.F_ACTIVITY, ActivityDefinitionType.F_MONITORING)),
