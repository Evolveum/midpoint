 ...
 */
public class CustomSelectableCardDataTable<T> extends CardDataTable<T, String> {

    public CustomSelectableCardDataTable(String id, List<IColumn<T, String>> columns, IDataProvider<T> dataProvider, int rowsPerPage) {
