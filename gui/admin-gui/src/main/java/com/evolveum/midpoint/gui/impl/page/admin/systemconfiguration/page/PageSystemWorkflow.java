...
@PageDescriptor(
        urls = {
                @Url(mountUrl = "/admin/config/system/workflow"),
        },
        action = {
...
public class PageSystemWorkflow extends PageBaseSystemConfiguration {

    private static final long serialVersionUID = 1L;

    public PageSystemWorkflow() {
    }

    public PageSystemWorkflow(PageParameters parameters) {
        super(parameters);
    }

    public PageSystemWorkflow(PrismObject<SystemConfigurationType> object) {
        super(object);
    }
