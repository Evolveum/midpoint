...
public class DebugPagesController implements Serializable {
	...
	private void delete() {
		if ("".equals(id) || id == null) {
			...
			// FacesMessage("Object ID must be declared"));
			return;
		}
		...
		try {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Delete object failed with exception " + message));
			return;
		} catch (Exception ex) {
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Delete object failed with exception " +
			// ex.getMessage()));
	...
	public String editObject() {
		...
		if ("".equals(objectXml) || objectXml == null) {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Object must be declared."));
		}
		...
		try {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Edit object failed with exception " +
			// ex.getMessage()));
		...
		try {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Edit object failed with exception " + message));
		} catch (Exception ex) {
			FacesUtils.addErrorMessage("Edit object failed with exception " + ex.getMessage());
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Edit object failed with exception " +
		...
		return PAGE_NAVIGATION_DEBUG_MAIN;
	}
	...
	private ObjectContainerType getDebugObject(String oid) {
		...
		try {
			...
			logger.trace("getDebugObject() returns (wrapped as JAXBObject object): {}",
					JAXBUtil.silentMarshalWrap(result.getObject(), SchemaConstants.I_OBJECT));
			return result;
		} catch (FaultMessage ex) {
			String message = (ex.getFaultInfo().getMessage() != null ? ex.getFaultInfo().getMessage() : ex
					.getMessage());
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Get object failed with exception " + message));
			return null;
		} catch (Exception ex) {
			FacesUtils.addErrorMessage("Get object failed with exception " + ex.getMessage());
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Get object failed with exception " +
			// ex.getMessage()));
	...
	public String viewAction() {
		...
		if ("".equals(id) || id == null) {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Object ID to be viewed cannot be null"));
			return "";
		}
		...
		try {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("View object failed: " + ex.getMessage()));
			logger.info("Marshal failed");
			logger.error("Exception was {} ", ex);
			return "";
		}

		return PAGE_NAVIGATION_DEBUG_VIEW;
	...
	public String getObject() {
		...
		if ("".equals(id) || id == null) {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Object ID cannot be null"));
			return "";
		}
		...
		return PAGE_NAVIGATION_DEBUG_LIST;
	}
	...
	public String listObjects() {
		...
		if ("".equals(objectType) || objectType == null) {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Object type must be chosen."));
			return "";
		}
		...
		try {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("List object failed with exception " + message));
		} catch (Exception ex) {
			FacesUtils.addErrorMessage("List object failed with exception " + ex.getMessage());
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("List object failed with exception " +
			// ex.getMessage()));
	...
	public String addObject() {
		...
		try {
			...
			FacesUtils.addErrorMessage("Add object failed. The XML Schema is not valid.Exception was: "
					+ ex.getMessage());
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Add object failed. The XML Schema is not valid.Exception was: "
			// + ex.getMessage()));
			logger.info("Unmarshal of Object type {} failed");
			logger.error("Exception was {} ", ex);
			return "";
		...
		try {
			...
			// FacesContext.getCurrentInstance().addMessage("", new
			// FacesMessage("Add object failed with exception " + message));
			return "";
		} catch (Exception ex) {
