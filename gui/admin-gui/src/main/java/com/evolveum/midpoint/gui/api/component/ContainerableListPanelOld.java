 ...
 * Created by honchar
 */
public abstract class ContainerableListPanelOld<C extends Containerable> extends BasePanel<C>{
    private static final long serialVersionUID = 1L;

    private static final Trace LOGGER = TraceManager.getTrace(ContainerableListPanelOld.class);
    ...
    public ContainerableListPanelOld(String id, UserProfileStorage.TableId tableId){
        super(id);
    ...
    private void initSearchModel() {
        searchModel = new LoadableModel<Search>(false) {
            ...
            public Search load() {
                ...
                if (search == null) {
                    search = SearchFactory.createContainerSearch(getType(), ContainerableListPanelOld.this.getPageBase());
                }
                return search;
            }
        };
        ...
        BoxedTablePanel<PrismContainerValueWrapper<C>> table =
                new BoxedTablePanel<PrismContainerValueWrapper<C>>(ID_TABLE, provider, initColumns(),
                    ...
                    protected WebMarkupContainer createHeader(String headerId) {
                        SearchFormPanel searchPanel = new SearchFormPanel(headerId, searchModel) {
                            ...
                            protected void searchPerformed(ObjectQuery query, AjaxRequestTarget target) {
                                ContainerableListPanelOld.this.searchPerformed(target);
                            }
                    ...
                    protected boolean hideFooterIfSinglePage(){
                        return ContainerableListPanelOld.this.hideFooterIfSinglePage();
                    }
                };
