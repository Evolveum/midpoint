...
public class CreateEndpointsConnectorStepPanel extends EndpointsConnectorStepPanel {
    ...
    protected Collection<ConnDevHttpEndpointIntentType> getEndpointIntents() {
        return List.of(ConnDevHttpEndpointIntentType.CREATE);
    }
    ...
    protected List<HelpTab> computeHelpTabs() {
        return ConnectorDevelopmentWizardUtil.helpTabs(getDetailsModel(), ConnectorWizardHelpTopics.CREATE_ENDPOINT, ConnectorWizardHelpTopics.ENDPOINT_SELECTION);
    }
}
