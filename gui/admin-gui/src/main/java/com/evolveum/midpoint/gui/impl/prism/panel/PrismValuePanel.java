...
public abstract class PrismValuePanel<T, IW extends ItemWrapper, VW extends PrismValueWrapper<T>> extends BasePanel<VW> {
    ...
    protected static final String ID_HEADER_STATUS_MESSAGE = "headerStatusMessage";
    ...
    protected WebMarkupContainer createHeaderPanel() {
        ...
        WebMarkupContainer statusMessage = new WebMarkupContainer(ID_HEADER_STATUS_MESSAGE);
        ...
        showMetadataButton.add(AttributeAppender.append("aria-label", () -> getString(
