 ...
 */
public class MailTransportCounter extends SimpleCounter<AssignmentHolderDetailsModel<SystemConfigurationType>, SystemConfigurationType> {

    public MailTransportCounter() {
        super();
    }
    ...
    public int count(AssignmentHolderDetailsModel<SystemConfigurationType> model, PageBase pageBase) {
        ...
        return mtc != null ? mtc.getMail().size() : 0;
    }
}
