...
public class ExploratoryModeConfiguration extends AbstractAnalysisOption {

    RoleAnalysisService service;
    Task task;
    OperationResult result;

    public ExploratoryModeConfiguration(RoleAnalysisService service, Task task, OperationResult result) {
