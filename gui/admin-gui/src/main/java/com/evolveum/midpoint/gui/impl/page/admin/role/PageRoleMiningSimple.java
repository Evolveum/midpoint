...
import com.evolveum.midpoint.gui.impl.page.admin.role.panels.GenerateDataPanel;
...
public class PageRoleMiningSimple extends PageAdmin {
    ...
    private List<PrismObject<UserType>> getMembers(String objectId) {
        ...
        try {
            return getPageBase().getMidpointApplication().getRepositoryService().searchObjects(UserType.class,createMembersQuery(objectId),null,result);
