...
public class PageResourceOld extends PageAdminResources {

    private static final Trace LOGGER = TraceManager.getTrace(PageResourceOld.class);

    private static final String DOT_CLASS = PageResourceOld.class.getName() + ".";
    ...
    public PageResourceOld() {
        initialize();
    }

    public PageResourceOld(PageParameters parameters, PageTemplate previousPage) {
    ...
    private IModel<String> createTestConnectionStateTooltip(final String expression) {
        return new AbstractReadOnlyModel<String>() {
            ...
            public String getObject() {
                ...
                return PageResourceOld.this.getString(OperationResultStatus.class.getSimpleName() + "." + status.name());
            }
        };
    }
