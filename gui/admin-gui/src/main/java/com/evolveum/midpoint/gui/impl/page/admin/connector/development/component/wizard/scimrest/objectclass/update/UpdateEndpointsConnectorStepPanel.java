...
public class UpdateEndpointsConnectorStepPanel extends EndpointsConnectorStepPanel {
    ...
    protected ItemPath getScriptItemName() {
        return ConnDevObjectClassInfoType.F_UPDATE_SCRIPT;
    }

    @Override
    protected List<HelpTab> computeHelpTabs() {
        return ConnectorDevelopmentWizardUtil.helpTabs(getDetailsModel(), ConnectorWizardHelpTopics.UPDATE_ENDPOINT, ConnectorWizardHelpTopics.ENDPOINT_SELECTION);
    }
}
