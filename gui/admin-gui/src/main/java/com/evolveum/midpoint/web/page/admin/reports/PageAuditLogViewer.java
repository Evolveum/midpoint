...
public class PageAuditLogViewer extends PageBase {
	...
	private static final String OPERATION_RESOLVE_REFENRENCE_NAME = PageAuditLogViewer.class.getSimpleName()
...
//	}
	...
	private void createReferenceColumn(ObjectReferenceType ref, Item item, String componentId) {
		String name = WebModelServiceUtils.resolveReferenceName(ref, this,
