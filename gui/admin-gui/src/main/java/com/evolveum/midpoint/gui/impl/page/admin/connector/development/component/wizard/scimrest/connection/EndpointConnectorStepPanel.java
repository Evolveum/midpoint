...
public class EndpointConnectorStepPanel extends AbstractWizardStepPanel<ConnectorDevelopmentDetailsModel> implements WizardListener {
    ...
    protected List<HelpTab> computeHelpTabs() {
        return ConnectorDevelopmentWizardUtil.helpTabs(getDetailsModel(), ConnectorWizardHelpTopics.CONNECTIVITY_ENDPOINT, ConnectorWizardHelpTopics.ENDPOINT_SELECTION);
    }
}
