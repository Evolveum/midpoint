...
@PanelType(name = "clusterOutliers")
@PanelInstance(
        identifier = "clusterOutliers",
...
public class RoleAnalysisClusterOperationPanel extends AbstractObjectMainPanel<RoleAnalysisOutlierType, ObjectDetailsModels<RoleAnalysisOutlierType>> {
    ...
    public RoleAnalysisClusterOperationPanel(String id, ObjectDetailsModels<RoleAnalysisOutlierType> model,
    ...
    public RoleAnalysisRoleBasedTable generateMiningRoleBasedTable(List<DetectedPattern> intersection) {
        ...
        return new RoleAnalysisRoleBasedTable(ID_DATATABLE,
                ...
                intersection,
                displayValueOptionModel, cluster.asPrismObject()) {
