 ...
 * Created by honchar.
 */
public class TaskErrorDto2<O extends ObjectType> extends SelectableBeanImpl<O> {
    ...
    public TaskErrorDto2() {
    }

    public TaskErrorDto2(@NotNull O object, @NotNull String taskOid) {
