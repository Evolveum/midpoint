...
//                    }
    ...
    protected void newObjectPerformed(AssignmentObjectRelation relationSpec, AjaxRequestTarget target) {
        if (relationSpec != null) {
            try {
                ...
                DetailsPageUtil.initNewObjectWithReferenceAndRedirect(AbstractRoleMemberPanel.this.getPageBase(), newMemberType, newReferences);
    ...
    private <AH extends AssignmentHolderType> Class<? extends AssignmentHolderType>  getDefaultValueFromSearchBoxConfig(SearchBoxConfigurationType config) {
        ...
        if (defaultValue != null) {
            return (Class<AH>) WebComponentUtil.qnameToClass(PrismContext.get(), defaultValue);
        }
        return null;
    }
}
