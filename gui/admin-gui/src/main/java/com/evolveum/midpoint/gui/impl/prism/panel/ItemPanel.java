...
public abstract class ItemPanel<VW extends PrismValueWrapper<?, ? extends PrismValue>, IW extends ItemWrapper> extends BasePanel<IW> implements RefreshableTabPanel {
    ...
    private ItemHeaderPanel.ItemPanelSettings itemPanelSettings;


    public ItemPanel(String id, IModel<IW> model, ItemHeaderPanel.ItemPanelSettings itemPanelSettings) {
        super(id, model);
    ...
    public ItemHeaderPanel.ItemPanelSettings getSettings() {
