...
//        }
    ...
    public static class ItemPanelSettings implements Serializable {
    ...
    public static class ItemPanelSettingsBuilder {
     ...
     *
     */
    public static class ItemWrapperComparator<IW extends ItemWrapper> implements Comparator<IW> {
