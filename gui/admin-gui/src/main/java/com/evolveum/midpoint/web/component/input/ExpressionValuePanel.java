            ...
            protected ObjectQuery getChooseQuery() {
                ...
                try {
                    ...
                    for (RefinedAssociationDefinition refinedAssociationDefinition : refinedAssociationDefinitions) {
                        S_FilterEntryOrEmpty atomicFilter = pageBase.getPrismContext().queryFor(ShadowType.class);
                        ...
                        OrFilter intentFilter = getPrismContext().queryFactory().createOr(orFilterClauses);
