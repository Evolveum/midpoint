...
public class ResourcesSelectionPanel extends BasePanel {
    ...
    public static abstract class Context implements Serializable {
        ...
        abstract public SimpleUserResourceProvider getProvider();

        abstract public void addPerformed(AjaxRequestTarget target, List<ResourceType> newResources);
    ...
    public ResourcesSelectionPanel(String id, Context context) {
        super(id, null);
    ...
    protected void initLayout() {
        ...
        TablePanel resources = new TablePanel<>(ID_TABLE,
                context.getProvider(), initResourceColumns());
        ...
        AjaxButton addButton = new AjaxButton(ID_ADD,
            ...
            public void onClick(AjaxRequestTarget target) {
                context.addPerformed(target, getSelectedResources());
            }
        };
        add(addButton);
    }
