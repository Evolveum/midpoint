...
/**
 * Waiting step for Search By ID (search one / read by ID) script generation.
 */
@PanelType(name = "cdw-connector-waiting-search-by-id")
@PanelInstance(identifier = "cdw-connector-waiting-search-by-id",
        applicableForType = ConnectorDevelopmentType.class,
        applicableForOperation = OperationTypeType.WIZARD,
        display = @PanelDisplay(label = "PageConnectorDevelopment.wizard.step.connectorWaitingSearchById", icon = "fa fa-wrench"),
        containerPath = "empty")
public class WaitingSearchByIdConnectorStepPanel extends WaitingObjectClassScriptConnectorStepPanel {

    private static final String PANEL_TYPE = "cdw-connector-waiting-search-by-id";

    public WaitingSearchByIdConnectorStepPanel(
    ...
    protected String getKeyForStoringToken() {
        return SearchByIdScriptConnectorStepPanel.TASK_SEARCH_BY_ID_SCRIPTS_KEY;
    }
    ...
    public IModel<String> getTitle() {
        return createStringResource("PageConnectorDevelopment.wizard.step.connectorWaitingSearchById");
    }

    @Override
    protected IModel<String> getTextModel() {
        return createStringResource("PageConnectorDevelopment.wizard.step.connectorWaitingSearchById.text");
    }

    @Override
    protected IModel<String> getSubTextModel() {
        return createStringResource("PageConnectorDevelopment.wizard.step.connectorWaitingSearchById.subText");
    }
