...
public class TaskSchedulingTabPanel extends AbstractObjectTabPanel<TaskType> {
	...
	protected static final String ID_BINDING = "binding";
	...
	private void initLayout(PageBase pageBase) {
		...
		PrismPropertyPanel bindingPanel = new PrismPropertyPanel<>(ID_BINDING,
				new PropertyWrapperFromObjectWrapperModel(getObjectWrapperModel(), TaskType.F_BINDING),
				null, pageBase);
		bindingPanel.setLabelContainerVisible(false);
		add(bindingPanel);
