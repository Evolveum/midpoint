 ...
 * @author mederly
 */
public class AlreadyShownTriggerRecord {
	final EvaluatedTriggerDto originalTriggerDto;
	final EvaluatedPolicyRuleTriggerType anonymizedTrigger;

	public AlreadyShownTriggerRecord(EvaluatedTriggerDto originalTriggerDto,
			EvaluatedPolicyRuleTriggerType anonymizedTrigger) {
		this.originalTriggerDto = originalTriggerDto;
