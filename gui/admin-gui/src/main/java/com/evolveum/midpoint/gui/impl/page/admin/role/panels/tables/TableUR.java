...
public class TableUR extends Panel {
    ...
    public TableUR(String id, List<UrType> userRoleList, List<PrismObject<RoleType>> rolePrismObjectList) {
        super(id);
        add(generateTableRM(userRoleList, rolePrismObjectList));
    ...
    public BoxedTablePanel<UrType> generateTableRM(List<UrType> userRoleList, List<PrismObject<RoleType>> rolePrismObjectList) {
