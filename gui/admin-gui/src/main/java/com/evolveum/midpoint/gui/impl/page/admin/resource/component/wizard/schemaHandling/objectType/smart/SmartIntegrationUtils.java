...
public class SmartIntegrationUtils {
    ...
    public enum SuggestionUiStyle {
        ...
        SuggestionUiStyle(String rowClass, String badgeClass, String tileClass) {
    ...
    public static void removeCorrelationTypeSuggestion(
            @NotNull PageBase pageBase,
            @NotNull StatusInfo<CorrelationSuggestionType> statusInfo,
            @NotNull Task task,
            @NotNull OperationResult result) {
        ...
        try {
            ...
            modelService.executeChanges(Collections.singletonList(delta), null, task, result);
            result.recordSuccessIfUnknown();
            LOGGER.info("Removed correlation suggestion and deleted task {}", token);
