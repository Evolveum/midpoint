...
/**
 * Created by honchar
 * the panel is to be used as a content component
 * for main popup window from the PageBase class
 */
public class MultiplicityPolicyPanel extends Panel{
    ...
    private WebMarkupContainer getMultiplicityContainer(){
        return (WebMarkupContainer) get(StringUtils.join(new String[]{ID_MAIN_FORM, ID_MULTIPLICITY_CONTAINER}, ":"));
    }
