...
@Experimental
public class CredentialsWizardPanel extends AbstractWizardPanel<ResourceCredentialsDefinitionType, ResourceDetailsModel> {

    public CredentialsWizardPanel(String id, WizardPanelHelper<ResourceCredentialsDefinitionType, ResourceDetailsModel> helper) {
        super(id, helper);
    }
    ...
    private CredentialsMappingWizardPanel createCredentialsTablePanel(MappingDirection mappingDirection) {
        PrismContainerWrapperModel<ResourceCredentialsDefinitionType, ResourceCredentialsDefinitionType> containerModel =
                PrismContainerWrapperModel.fromContainerValueWrapper(getValueModel());
