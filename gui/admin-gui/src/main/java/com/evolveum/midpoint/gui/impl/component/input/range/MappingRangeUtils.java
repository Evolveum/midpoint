...
public class MappingRangeUtils {
     ...
     */
    public static final ItemPath AUTOASSIGN_MAPPING_PATH = ItemPath.create(
            AbstractRoleType.F_AUTOASSIGN, AutoassignSpecificationType.F_FOCUS, FocalAutoassignSpecificationType.F_MAPPING);
