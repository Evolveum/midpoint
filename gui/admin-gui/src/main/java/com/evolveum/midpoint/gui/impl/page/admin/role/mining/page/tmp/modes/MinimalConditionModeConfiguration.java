...
public class MinimalConditionModeConfiguration extends AbstractAnalysisOption {

    RoleAnalysisService service;
    Task task;
    OperationResult result;

    public MinimalConditionModeConfiguration(RoleAnalysisService service, Task task, OperationResult result) {
        this.service = service;
        this.task = task;
        this.result = result;
    }

    public MinimalConditionModeConfiguration() {
        super();
    }
