...
public enum PageUrlMapping {
    ...
    ADMIN_USER_PREVIEW("/admin/userPreview", PageUserPreview.class, MidPointPageParametersEncoder.ENCODER, new String[]{AuthorizationConstants.AUTZ_DENY_ALL_URL}),
    ADMIN_USERS_BULK("/admin/users/bulk", PageBulkUsers.class, MidPointPageParametersEncoder.ENCODER, new String[]{AuthorizationConstants.AUTZ_DENY_ALL_URL}),
    ...
    RESOURCE_WIZARD("/admin/resourceWizard", PageResourceWizard.class, new OnePageParameterEncoder(PageResourceWizard.PARAM_RESOURCE_ID), new String[]{AuthorizationConstants.AUTZ_DENY_ALL_URL}),
    RESOURCE_WIZARD_ALL("/admin/resourceWizard/**", PageResourceWizard.class, new OnePageParameterEncoder(PageResourceWizard.PARAM_RESOURCE_ID), new String[]{AuthorizationConstants.AUTZ_DENY_ALL_URL}),
    ...
    RESOURCES_CONTENT_ENTITLEMENTS("/admin/resources/content/entitlements", PageContentEntitlements.class, new OnePageParameterEncoder(PageContentEntitlements.PARAM_RESOURCE_ID), new String[]{AuthorizationConstants.AUTZ_DENY_ALL_URL}),
    ...
    CONFIG_TEST("/admin/config/test", PageTest.class, MidPointPageParametersEncoder.ENCODER, new String[]{AuthorizationConstants.AUTZ_DENY_ALL_URL});
