 ...
 *
 */
public class TaskInternalPerformanceTabPanelNew extends BasePanel<PrismContainerWrapper<OperationStatsType>> implements TaskTabPanel {
    private static final long serialVersionUID = 1L;

    private static final transient Trace LOGGER = TraceManager.getTrace(TaskInternalPerformanceTabPanelNew.class);
    ...
    public TaskInternalPerformanceTabPanelNew(String id, IModel<PrismContainerWrapper<OperationStatsType>> statsModel) {
        super(id, statsModel);
    }
