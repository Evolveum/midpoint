...
public class GuiStyleConstants {
    ...
    public static final String CLASS_BOX_DEFAULT = "card border";
    ...
    public static final String CLASS_OP_RESULT_STATUS_ICON_UNKNOWN_COLORED = "fa fa-question-circle text-secondary";
