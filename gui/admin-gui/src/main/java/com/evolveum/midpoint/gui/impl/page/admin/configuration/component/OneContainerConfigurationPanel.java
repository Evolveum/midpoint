 ...
 * @author skublik
 */
public class OneContainerConfigurationPanel<C extends Containerable> extends BasePanel<ObjectWrapper<SystemConfigurationType>> {
    ...
    public OneContainerConfigurationPanel(String id, IModel<ObjectWrapper<SystemConfigurationType>> model, QName qNameContainer) {
        super(id, model);
