...
import com.evolveum.midpoint.gui.impl.page.admin.connector.development.component.wizard.scimrest.basic.ConnectorIdentificationConnectorStepPanel;
 ...
 * @author lskublik
 */
@PanelType(name = "cdw-association")
@PanelInstance(identifier = "cdw-association",
        applicableForType = ConnectorDevelopmentType.class,
        applicableForOperation = OperationTypeType.WIZARD,
        display = @PanelDisplay(label = "PageConnectorDevelopment.wizard.step.association", icon = "fa fa-wrench"),
        containerPath = "empty")
public class AssociationConnectorStepPanel extends AbstractFormWizardStepPanel<ConnectorDevelopmentDetailsModel> implements WizardParentStep {

    private static final String PANEL_TYPE = "cdw-association";

    public AssociationConnectorStepPanel(ConnectorDevelopmentDetailsModel model) {
        super(model);
    }
...
//        getTopLevelContainer().add(AttributeAppender.replace("class", "d-flex flex-column col-9 mt-2"));
        ...
        VerticalFormPanel panel = new VerticalFormPanel(ID_FORM, getContainerFormModel(), settings, getContainerConfiguration()) {
            ...
            protected String getIcon() {
                return AssociationConnectorStepPanel.this.getIcon();
            }
    ...
    public IModel<String> getTitle() {
        return createStringResource("PageConnectorDevelopment.wizard.step.association");
    }

    @Override
    protected IModel<?> getTextModel() {
        return createStringResource("PageConnectorDevelopment.wizard.step.association.text");
    }

    @Override
    protected IModel<?> getSubTextModel() {
        return createStringResource("PageConnectorDevelopment.wizard.step.association.subText");
    }
