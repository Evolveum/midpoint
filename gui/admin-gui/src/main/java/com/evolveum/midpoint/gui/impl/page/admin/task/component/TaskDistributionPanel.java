...
public class TaskDistributionPanel extends AbstractObjectMainPanel<TaskType> {
    ...
    public TaskDistributionPanel(String id, LoadableModel<PrismObjectWrapper<TaskType>> model, ContainerPanelConfigurationType config) {
