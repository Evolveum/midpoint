...
@PanelInstance(identifier = "rw-synchronization-reaction-action",
        ...
        expanded = true)
@PanelInstance(identifier = "rw-association-synchronization-reaction-action",
        applicableForType = ResourceType.class,
        applicableForOperation = OperationTypeType.WIZARD,
        display = @PanelDisplay(label = "PageResource.wizard.step.synchronization.reaction.action", icon = "fa fa-wrench"),
        expanded = true)
public class ActionStepPanel extends AbstractWizardStepPanel {
    ...
    private Component createValuePanel() {
        ...
        settings.panelConfiguration(getContainerConfiguration(getPanelType()));
    ...
    protected String getPanelType() {
        if (parentValueModel.getObject().getParentContainerValue(ResourceObjectTypeDefinitionType.class) != null) {
