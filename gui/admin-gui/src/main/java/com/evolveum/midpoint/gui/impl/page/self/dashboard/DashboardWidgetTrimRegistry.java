...
import com.evolveum.midpoint.gui.impl.page.admin.assignmentholder.component.assignmentType.assignment.PolicyAssignmentsPanel;
...
final class DashboardWidgetTrimRegistry {
    ...
    static {
        ...
        SUPPORTED_PANELS.put(ServiceAssignmentsPanel.class, new Support(
                    ...
                    rule -> AssignmentPanelQueries.defaultAssignments(rule != null ? rule.targetType() : null)));
        SUPPORTED_PANELS.put(PolicyAssignmentsPanel.class, new Support(
                    PolicyAssignmentsPanel::contributeFocusTrimPlan,
                    rule -> AssignmentPanelQueries.defaultAssignments(rule != null ? rule.targetType() : null)));
