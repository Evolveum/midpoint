        ...
        return new ProcessedObjectsProvider(this, getSearchModel()) {
            ...
            protected ObjectQuery getCustomizeContentQuery() {
                ...
                return getPrismContext().queryFor(SimulationResultProcessedObjectType.class)
                        ...
                        .and()
                        .block()
                            .item(SimulationResultProcessedObjectType.F_RESULT_STATUS).eq(OperationResultStatusType.FATAL_ERROR)
                            .or()
                            .item(SimulationResultProcessedObjectType.F_RESULT_STATUS).eq(OperationResultStatusType.PARTIAL_ERROR)
                        .endBlock()
                        .build();
            }
        };
