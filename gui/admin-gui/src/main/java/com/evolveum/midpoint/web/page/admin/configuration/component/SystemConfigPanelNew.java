...
public class SystemConfigPanelNew extends BasePanel<ObjectWrapper<SystemConfigurationType>> {
    ...
    public static final QName C_LOGGING = new QName(SchemaConstants.NS_C, "logging");
	public static final ItemPath PATH_LOGGING = new ItemPath(C_LOGGING);
	
	public static final QName C_GLOBAL_PASSWORD_POLICY = new QName(SchemaConstants.NS_C, "globalSecurityPolicyRef");
	public static final ItemPath PATH_GLOBAL_PASSWORD_POLICY = new ItemPath(C_GLOBAL_PASSWORD_POLICY);
    ...
    public SystemConfigPanelNew(String id, IModel<ObjectWrapper<SystemConfigurationType>> model, Form form, PageBase page) {
        super(id, model);
    ...
    protected void initLayout() {
		...
		new ContainerWrapperListFromObjectWrapperModel(getModel(), getVisibleContainers()), 
		null, mainForm, 
		null, pageBase);
		add(panel);
    }
	...
	private List<ItemPath> getVisibleContainers() {
		...
		paths.addAll(Arrays.asList(ItemPath.EMPTY_PATH, PATH_GLOBAL_PASSWORD_POLICY, PATH_LOGGING));//, SchemaConstants.PATH_ACTIVATION, SchemaConstants.PATH_PASSWORD));
		return paths;
	}
...
//                WebComponentUtil.createReadonlyModelFromEnum(AEPlevel.class), new EnumChoiceRenderer<AEPlevel>(SystemConfigPanelNew.this),
