    ...
    private void initOperationPanel() {
        ...
        public  RoleAnalysisTable<A> generateTable() {
            ...
            RoleAnalysisTable<A> table = new RoleAnalysisTable<>(
                    ...
                    initColumns(),
                    null, true, 100, displayValueOptionModel) {
    ...
    public List<IColumn<A, String>> initColumns() {
        ...
        columns.add(new RoleAnalysisObjectColumn<>(
            ...
            protected void setRelationSelected(boolean isRelationSelected) {
                RoleAnalysisMatrixTable.this.isRelationSelected = isRelationSelected;
            }

            @Override
            protected boolean isOutlierDetection() {
                return RoleAnalysisMatrixTable.this.isOutlierDetection();
            }
        ...
        MiningOperationChunk chunk = miningOperationChunk.getObject();
        List<B> mainChunk = chunk.getMainMiningChunk();

        for (int i = fromCol - 1; i < mainChunk.size(); i++) {
            ...
            column = new RoleAnalysisIntersectionColumn<>(
                ...
                protected Set<String> getMarkMemberObjects() {
                    return RoleAnalysisMatrixTable.this.getMarkMemberObjects();
                }

                @Override
                protected Set<String> getMarkPropertyObjects() {
                    return RoleAnalysisMatrixTable.this.getMarkPropertyObjects();
                }
                ...
                protected void loadDetectedPattern(AjaxRequestTarget target) {
                    RoleAnalysisMatrixTable.this.loadDetectedPattern(target);
                }
