...
public class ComplexTypeDefinitionPanelOld extends DefinitionPanel<ComplexTypeDefinitionDto> {

    public ComplexTypeDefinitionPanelOld(String id, IModel<ComplexTypeDefinitionDto> model) {
        super(id, model);
    }
    ...
    protected void initLayout() {
        ...
        DefinitionTablePanel<? extends ItemDefinitionDto> definitions = new DefinitionTablePanel<>("definitions", new PropertyModel<>(getModel(), ComplexTypeDefinitionDto.F_DEFINITIONS)) {
            ...
            protected void newDefinitionAdded(AjaxRequestTarget target, ItemDefinitionDto newDefinition) {
                ComplexTypeDefinitionPanelOld.this.getModelObject().getOriginalDefinition()
                        .mutator()
            ...
            protected PrismPropertyDefinition<Object> createNewDefinition() {
                String namespace = ComplexTypeDefinitionPanelOld.this.getModel().getObject().getOriginalDefinition().getDefaultNamespace();
