...
/**
 * Wizard step showing the results of Search Filter script execution.
 */
@PanelType(name = "cdw-show-search-filter-result")
@PanelInstance(identifier = "cdw-show-search-filter-result",
        applicableForType = ConnectorDevelopmentType.class,
        applicableForOperation = OperationTypeType.WIZARD,
        display = @PanelDisplay(label = "PageConnectorDevelopment.wizard.step.showSearchFilterResult", icon = "fa fa-wrench"),
        containerPath = "empty")
public class SearchFilterObjectsConnectorStepPanel extends ScriptConfirmationPanel {

    private static final String PANEL_TYPE = "cdw-show-search-filter-result";

    private static final String ID_PANEL = "panel";

    public SearchFilterObjectsConnectorStepPanel(WizardPanelHelper<? extends Containerable,
    ...
    protected List<ConnectorDevelopmentArtifacts.KnownArtifactType> getScriptClassifications() {
        return List.of(ConnectorDevelopmentArtifacts.KnownArtifactType.SEARCH_FILTER_DEFINITION);
    }
    ...
    public IModel<String> getTitle() {
        return createStringResource("PageConnectorDevelopment.wizard.step.showSearchFilterResult");
    }

    @Override
    protected IModel<?> getTextModel() {
        return createStringResource("PageConnectorDevelopment.wizard.step.showSearchFilterResult.text");
    }

    @Override
    protected IModel<?> getSubTextModel() {
        return createStringResource("PageConnectorDevelopment.wizard.step.showSearchFilterResult.subText");
    }
