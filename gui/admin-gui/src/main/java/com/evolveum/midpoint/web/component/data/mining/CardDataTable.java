 ...
 */
public class CardDataTable<T, S> extends DataTable<T, S> {

    public CardDataTable(String id, List<? extends IColumn<T, S>> columns, IDataProvider<T> dataProvider, long rowsPerPage) {
