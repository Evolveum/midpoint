 ...
 * @author semancik
 */
public class PropertyWrapperFromObjectWrapperModel<T,O extends ObjectType> extends AbstractWrapperModel<PropertyWrapper<PrismProperty<T>>,O> {
    ...
    @Override
    public PropertyWrapper<PrismProperty<T>> getObject() {
    	PropertyWrapper<PrismProperty<T>> propertyWrapper = getWrapper().findPropertyWrapper(path);
        return propertyWrapper;
    }

    @Override
    public void setObject(PropertyWrapper<PrismProperty<T>> object) {
