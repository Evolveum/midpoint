...
public class TestDisplayLabelLocalization extends AbstractGuiIntegrationTest {
    ...
    public void testAssignmentObjectRelationDisplayLabelLocalization() throws Exception {
        ...
        assertEquals(translatedLabel, new TestSummaryPanel().callTranslateDisplayLabelOrDefault(display));
    }
    ...
    public void testOrigDisplayLabelFallback() {
        ...
        assertEquals("MyApp", new TestSummaryPanel().callTranslateDisplayLabelOrDefault(display));
    }
    ...
    public void testMissingDisplayLabelFallbackToDefault() {
        ...
        assertEquals("", new TestSummaryPanel().callTranslateDisplayLabelOrDefault(display));
    }
    ...
    private static class TestSummaryPanel extends AbstractSummaryPanel<UserType> {
        ...
        private String callTranslateDisplayLabelOrDefault(DisplayType display) {
            return translateDisplayLabelOrDefault(display);
        }
